													...
													<%
														for(int i = 0 ;i<borDateHoursFlightnameCountPair.get(keyValue).split("####").length;i++)
														{
															...
															else
															{
																...
																{%>
																	<tr>
																		<td style="background-color:#b2c7e0;border-color: #00539a;width:25%;font-weight: bold;text-align: left;" ><%=borDateHoursFlightnameCountPair.get(keyValue).split("####")[i].split("##")[0].replace("-","&#8209;")%>&nbsp;</td>
																		<td style="background-color:#d7e2ef;border-color: #da1e28;width:25%; font-weight: bold; text-align: right;" align="right"><%=(borDateHoursFlightnameCountPair.get(keyValue).split("####")[i]).split("##")[1]%></td>
																	</tr>
																<%}
																else
																{%>
																	<tr>
																		<td style="background-color:#ebdbd4;border-color: #00539a;width:25%;font-weight: bold;text-align: left;" ><%=borDateHoursFlightnameCountPair.get(keyValue).split("####")[i].split("##")[0].replace("-","&#8209;")%>&nbsp;</td>
																		<td style="background-color:#e5d2c9;border-color: #00539a;width:25%; font-weight: bold; text-align: right;" align="right"><%=(borDateHoursFlightnameCountPair.get(keyValue).split("####")[i]).split("##")[1]%></td>
																	</tr>
																<%}
															}
														}
				...
				%>				</tr>
								...
								<tr style="background-color:#E6E6EA;font-weight:bold">
									...
									%>									
											...
											<td style="text-align:center;"><%=convertToAmPm(keyValue.split("#####")[1])%></td>
									<%	
										}
									%>
								</tr>
