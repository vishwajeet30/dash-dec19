	...
	<div class="col-sm-3" style="flex:1;">
		<table class="tableDesign" >
			<tr style="font-size: 13px; font-family: 'Arial', serif;color: white; font-weight: bold; text-align: center;border-color: #1192e8;height:40px;">
				<th colspan="6" style="text-align: center;background-color:#007d79;border-color: #007d79; text-align: center;">Arrival : Biometric<BR>Enrollment/Verification/Exemption Statistics<BR> in last 7 days</th>
			</tr>
			<tr style="font-size: 11px; font-family: 'Arial', serif;color: white; font-weight: bold; border-color: #1192e8;height:40px;">
				<th style="background-color:#007d79;border-color: #004a48; text-align: center;">Date</th>
				<th style="background-color:#007d79;border-color: #004a48; text-align: right;">Enrolled</th>
				<th style="background-color:#007d79;border-color: #004a48; text-align: right;">Verified</th>
				<th style="background-color:#007d79;border-color: #004a48; text-align: right;">Exempted</th>
				<th style="background-color:#007d79;border-color: #004a48; text-align: right;">Failed</th>
				<th style="background-color:#007d79;border-color: #004a48; text-align: right;">Misc</th>
<!--  				<th style="background-color:#007d79;border-color: #004a48;width:20%; text-align: right;">Diff&nbsp;&nbsp;</th>
 --> 			</tr>
<%
...
try
	...
	while (rsTemp.next()){
		...
		Verified_Precent_Arr = 0;
			...
			%>
			<tr style="font-size: 12px; font-family: 'Arial', serif; border-color: #6929c4;height:18px;">
				<td style="background-color:#f0ffff;border-color:#007977; font-weight: bold;text-align: center;"><%=rsTemp.getString("pax_boarding_date_3").replace("-","&#8209;")%></td>
				<td style="background-color:#f0ffff;border-color:#007977; font-weight: bold; text-align: right;"><%=rsTemp.getInt("sum_HOURLY_BIO_ENROLLED") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("sum_HOURLY_BIO_ENROLLED"))%>&nbsp;</td>
				<td style="background-color:#f0ffff;border-color:#007977; font-weight: bold; text-align: right;"><%=rsTemp.getInt("sum_HOURLY_BIO_VERIFIED") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("sum_HOURLY_BIO_VERIFIED"))%>&nbsp;</td>
				<td style="background-color:#f0ffff;border-color:#007977; font-weight: bold; text-align: right;"><%=rsTemp.getInt("sum_HOURLY_BIO_EXEMPTED") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("sum_HOURLY_BIO_EXEMPTED"))%>&nbsp;</td>
				<td style="background-color:#f0ffff;border-color:#007977; font-weight: bold; text-align: right;"><%=rsTemp.getInt("sum_HOURLY_BIO_FAILURE") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("sum_HOURLY_BIO_FAILURE"))%>&nbsp;</td>
				<td style="background-color:#f0ffff;border-color:#007977; font-weight: bold; text-align: right;"><%=rsTemp.getInt("sum_HOURLY_BIO_MISC") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("sum_HOURLY_BIO_MISC"))%>&nbsp;</td>

				<!-- For Testing Purpose -->

<!--  			<td style="background-color:#f0ffff;border-color:#007977;width:33.33%; font-weight: bold; text-align:				right;font-size: 11px;"><%=getIndianFormat(arr_Foreigner_Daywise.get(rsTemp.getString("pax_boarding_date_3")))%>&nbsp;-&nbsp;<%=getIndianFormat(rsTemp.getInt("sum_HOURLY_BIO_ENROLLED") + rsTemp.getInt("sum_HOURLY_BIO_VERIFIED") + rsTemp.getInt("sum_HOURLY_BIO_EXEMPTED")) %>=<BR><font style="color:#007d79;font-size: 14px;"><%=getIndianFormat(arr_Foreigner_Daywise.get(rsTemp.getString("pax_boarding_date_3")) - (rsTemp.getInt("sum_HOURLY_BIO_ENROLLED") + rsTemp.getInt("sum_HOURLY_BIO_VERIFIED") + rsTemp.getInt("sum_HOURLY_BIO_EXEMPTED")))%><font>
			</td> -->
...
<div class="col-sm-3" style="flex:4;">
<div class="card" style="border: solid 3px #007d79; border-radius: 20px;height:430px;">
<div class="card-body" style=" height:430px;">
<canvas id="canvasWeeklyBio_Arr" class="chart" style="max-width: 100%;background: linear-gradient(to bottom, #ffffff 35%, #9ef0f0 100%); border-radius: 20px;height:430px; "></canvas>
</div>
</div>	
</div>
...
<%//////////////////////	Arrival : Biometric Enrollment/Verification/Exemption Statistics in last 7 days - Start	/////////////////////////////////
	...
	<div class="col-sm-3" style="flex:1;">
		<table class="tableDesign" >
			<tr style="font-size: 13px; font-family: 'Arial', serif;color: white; font-weight: bold; text-align: center;border-color: #1192e8;height:40px;">
				<th colspan="6" style="text-align: center;background-color:#e93d6b;border-color: #e93d6b; text-align: center;">Arrival : Biometric<BR> Enrollment/Verification/Exemption Statistics<BR> in last <%=displayHours%> hours</th> 
			</tr>
			<tr style="font-size: 11px; font-family: 'Arial', serif;color: white; font-weight: bold; text-align: center;border-color: #1192e8;height:40px;">
				<th style="text-align: center;background-color:#e93d6b;border-color: #c41645; text-align: center;">Time</th>
				<th style="text-align: center;background-color:#e93d6b;border-color: #c41645; text-align: right;">Enrolled</th>
				<th style="text-align: center;background-color:#e93d6b;border-color: #c41645; text-align: right;">Verified</th>
				<th style="text-align: center;background-color:#e93d6b;border-color: #c41645; text-align: right;">Exempted</th>
				<th style="text-align: center;background-color:#e93d6b;border-color: #c41645; text-align: right;">Failed</th>
				<th style="text-align: center;background-color:#e93d6b;border-color: #c41645; text-align: right;">Misc</th>
			</tr>
<%
...
try
	...
	while (rsTemp.next()){
		...
		Exempted_Precent_Arr = 0;
			...
			%>
			<tr style="font-size: 12px; font-family: 'Arial', serif; border-color: #6929c4;height:18px;">
				<td style="font-size: 11px;background-color:#ffeeee;border-color:#c41645;font-weight: bold;text-align: center;"><%=weeklyBioXAxis_Arrh.replace(" ","&nbsp;")%>&nbsp;</td>
				<td style="background-color:#ffeeee;border-color:#c41645; font-weight: bold; text-align: right;"><%=rsTemp.getInt("HOURLY_BIO_ENROLLED") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("HOURLY_BIO_ENROLLED"))%>&nbsp;</td>
				<td style="background-color:#ffeeee;border-color:#c41645; font-weight: bold; text-align: right;"><%=rsTemp.getInt("HOURLY_BIO_VERIFIED") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("HOURLY_BIO_VERIFIED"))%>&nbsp;</td>
				<td style="background-color:#ffeeee;border-color:#c41645; font-weight: bold; text-align: right;"><%=rsTemp.getInt("HOURLY_BIO_EXEMPTED") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("HOURLY_BIO_EXEMPTED"))%>&nbsp;</td>
				<td style="background-color:#ffeeee;border-color:#c41645; font-weight: bold; text-align: right;"><%=rsTemp.getInt("HOURLY_BIO_FAILURE") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("HOURLY_BIO_FAILURE"))%>&nbsp;</td>
				<td style="background-color:#ffeeee;border-color:#c41645; font-weight: bold; text-align: right;"><%=rsTemp.getInt("HOURLY_BIO_MISC") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("HOURLY_BIO_MISC"))%>&nbsp;</td>
			</tr>
			<%
	}
			rsTemp.close();
...
<div class="col-sm-3" style="flex:4;">
<div class="card" style="border: solid 3px #da1e28; border-radius: 20px;height:430px;">
<div class="card-body" style="height:430px;">
<canvas id="canvasWeeklyBio_Arrh" class="chart" style="max-width: 100%; background: linear-gradient(to bottom, #ffffff 35%, #f79bbe 100%); border-radius: 20px;height:430px; "></canvas>
	</div>
	</div>	
	</div>
	</div>
