...
<script>
		...
		<div class="menu">
		  <nav class="navbar navbar-expand-sm">
			<div class="container"> 
			  ...
			  <div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav">
				  ...
				  <li> <a class="scrollLink dropdown-item" href="#ICS_Gender">Gender Based Statistics in last 7 days</a></li>
				  <li> <a class="scrollLink dropdown-item" href="#ICS_Nationality">Nationality Based Statistics in last 7 days</a></li>
				  ...
				  <li> <a class="scrollLink dropdown-item" href="#ICS_Agewise">Agewise</a></ul></li>
			...
			<span class="airport_name"><font style="background-color:white; color:#0842af; font-weight: bold; font-size: 33px;">&nbsp;<%=capitalizeFirstChar(dash.replace("INTERNATIONAL",""))%>&nbsp;</font></span>
		  </nav>
...
<div class="row">
	<div class="col-sm-2">
		<table class="tableDesign">
			...
			<tr style="font-size: 16px;  text-align: right; color:white; border-color: #6929c4;height:20px; ">
				<th style="text-align: center;background-color:#6929c4;border-color: #be95ff;width:25%;text-align: center;">Date</th>
				<th style="text-align: center;background-color:#6929c4;border-color: #be95ff;width:33.33%; text-align: center;">Arr</th>
				<th style="text-align: center;background-color:#6929c4;border-color: #be95ff;width:33.33%; text-align: center;">Dep</th>
				<th style="text-align: center;background-color:#6929c4;border-color: #be95ff;width:33.33%; text-align: center;">Total</th>
			</tr>
		<% 
...
<div class="col-sm-2">
		<table class="tableDesign">
			...
			<tr style="font-size: 16px; font-family: 'Arial', serif;color: white; font-weight: bold; text-align: center;border-color: #ed3e12;height:20px;">
				<th style="text-align: center;background-color:#ed3e12;border-color: #f4896f;width:25%;">Date</th>
				<th style="text-align: center;background-color:#ed3e12;border-color: #f4896f;width:25%; text-align: center;">Arr</th>
				<th style="text-align: center;background-color:#ed3e12;border-color: #f4896f;width:25%; text-align: center;">Dep</th>
				<th style="text-align: center;background-color:#ed3e12;border-color: #f4896f;width:25%; text-align: center;">Total</th>
			</tr>
		<% 
...
<!--New-->
		...
		<!--   ************************END UCF DIV*******************END UCF DIV*****************END UCF DIV****************END UCF DIV********  -->
		<!--   ************************START TSC DIV************************START TSC DIV****************START TSC DIV********  -->
		<section class="aboutsection" id="ICS_Gender"><br><br><br><br><br><br><br>
		<div class="pt-4" id="ICS_Gender">    
		<table id = "auto-index8" class="table table-sm table-striped">
			<thead>
			<tr id='head1'>
...
<%//////////////////////	Male/Female Count in last 7 days - Start	/////////////////////////////////
	String WeeklyGender = "";
	...
	<div class="row">
		...
		<% 
			...
			<tr style="font-size: 16px; font-family: 'Arial', serif; text-align: center;height:20px;">
				...
				<td style="background-color:#ffd7d9;border-color: #da1e28;width:20%; font-weight: bold; text-align: right;"><%=weeklyOthersDays[i].equals("0") ? "&nbsp;" : weeklyOthersDays[i]%>&nbsp;&nbsp;</td>
...
<%
	...
	<div class="col-sm-8">
	<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Gender Based Statistics in last 7 days</h1>

		<canvas id="canvasWeeklyGender" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #f79bbe 100%);"></canvas>
	</div>
	</div>	
	</div>
	<script>
...
<!--   ************************END UCF DIV*******************END UCF DIV*****************END UCF DIV****************END UCF DIV********  -->
		<!--   ************************START TSC DIV************************START TSC DIV****************START TSC DIV********  -->
		<section class="aboutsection" id="ICS_Nationality"><br><br><br><br><br><br><br>
		<div class="pt-4" id="ICS_Nationality">    
		<table id = "auto-index8" class="table table-sm table-striped">
			<thead>
			<tr id='head1'>
...
<%
	...
	<div class="col-sm-8">
	<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Indian/Foreigner Statistics in last 7 days</h1>

		<canvas id="canvasWeeklyNationality" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #f79bbe 100%);"></canvas>
	</div>
	</div>	
	</div>
	<script>
...
%>
	...
	<table class="tableDesign">
		<!--<caption style="font-size: 22px; color: grey; line-height: 50px; text-align: center; padding-top: 5px;font-weight: bold; font-family: 'Arial', serif;">Arrival Clearance in last 7 hours</caption>-->
				...
				<tr style="font-size: 20px;  text-align: right; color:white; border-color: #003a6d;">
					<th colspan="6" style="text-align: center; width:25%; background-color:#491d8b;border-color: #491d8b;width:12.5%; text-align: center;">Arrival : Currently Running Flight Status</th>
				</tr>
				<tr style="font-size: 15px;  text-align: right; color:white; border-color: #003a6d;">
					<th style="text-align: center; width:25%; background-color:#6929c4;border-color: #491d8b;width:12.5%; text-align: center;">S.No.</th>
					<th style="text-align: center; width:25%; background-color:#6929c4;border-color: #491d8b;width:12.5%; text-align: center;">Scheduled&nbsp;Date</th>
					<th style="text-align: center; width:25%; background-color:#6929c4;border-color: #491d8b;width:12.5%; text-align: left;">Flight&nbsp;No.</th>
					...
					<th style="text-align: center; width:25%; background-color:#6929c4;border-color: #491d8b;width:12.5%; text-align: center;">First&nbsp;PAX&nbsp;Check&nbsp;Time</th>
					<th style="text-align: center; width:25%; background-color:#6929c4;border-color: #491d8b;width:12.5%; text-align: center;">Latest&nbsp;PAX&nbsp;Check&nbsp;Time</th>
					<th style="text-align: center; width:25%; background-color:#6929c4;border-color: #491d8b;width:12.5%; text-align: right;">PAX&nbsp;Checked&nbsp;&nbsp;</th>
				</tr>
		<% 
					int counter = 0;
	...
	while (rsTemp.next()) {	
		...
		<tr style="font-size: 12px; font-family: 'Arial', serif; height:20px;">
			<td style="background-color:#9958fc; width:25%; border-color: #491d8b;width:12.5%; font-weight: bold; text-align: center;"><%=++counter%></td>
			<td style="background-color:#a56eff; width:25%; border-color: #491d8b;width:12.5%; font-weight: bold; text-align: center;"><%=paxBoardingDate.replace(" ","&nbsp;")%></td>
			<td style="background-color:#b995ff; width:25%; border-color: #491d8b;width:12.5%; font-weight: bold; text-align: left;"><%=flightNo%></td>
			...
			<td style="background-color:#d4bbff; width:25%; border-color: #491d8b;width:12.5%; font-weight: bold; text-align: center;"><%=firstPaxCheckTime%></td>
			<td style="background-color:#e8daff; width:25%; border-color: #491d8b;width:12.5%; font-weight: bold; text-align: center;"><%=latestPaxCheckTime%></td>
			<td style="background-color:#f6f2ff; width:25%; border-color: #491d8b;width:12.5%; font-weight: bold; text-align: right; font-size:16px;"><%=totalPaxChecked%>&nbsp;&nbsp;</td>
		</tr>
<%
	}
	rsTemp.close();
...
%>
	...
	<table class="tableDesign">
		<!--<caption style="font-size: 22px; color: grey; line-height: 50px; text-align: center; padding-top: 5px;font-weight: bold; font-family: 'Arial', serif;">Arrival Clearance in last 7 hours</caption>-->
				...
				<tr style="font-size: 20px;  text-align: right; color:white; border-color: #003a6d;">
					<th colspan="6" style="text-align: center; width:25%; background-color:#004144;border-color: #004144;width:12.5%; text-align: center;">Departure : Currently Running Flight Status</th>
				</tr>
				<tr style="font-size: 15px;  text-align: right; color:white; border-color: #004144;">					
					<th style="text-align: center;  background-color:#005d5d;border-color: #004144; text-align: center;">S.No.</th>
					<th style="text-align: center;  background-color:#005d5d;border-color: #004144; text-align: center;">Scheduled&nbsp;Date</th>
					<th style="text-align: center;  background-color:#005d5d;border-color: #004144; text-align: left;">Flight&nbsp;No.</th>
					<!--<th style="text-align: center;  background-color:#B93160;border-color: #e497b2;width:12.5%; text-align: right;">Flight&nbsp;Description&nbsp;&nbsp;&nbsp;</th>-->
					<th style="text-align: center;  background-color:#005d5d;border-color: #004144;text-align: center;">First&nbsp;PAX&nbsp;Check&nbsp;Time</th>
					<th style="text-align: center;  background-color:#005d5d;border-color: #004144; text-align: center;">Latest&nbsp;PAX&nbsp;Check&nbsp;Time</th>
					<th style="text-align: center;  background-color:#005d5d;border-color: #004144; text-align: right;">PAX&nbsp;Checked&nbsp;&nbsp;</th>
				</tr>
		<% 
					int counter = 0;
	...
	while (rsTemp.next()) {	
		...
		%>
		<tr style="font-size: 12px; font-family: 'Arial', serif; height:20px;">
			<td style="background-color:#009d9a;  border-color: #004144; font-weight: bold; text-align: center;"><%=++counter%></td>
			<td style="background-color:#00afa9;  border-color: #004144; font-weight: bold; text-align: center;"><%=paxBoardingDate_Dep.replace(" ","&nbsp;")%></td>
			<td style="background-color:#08bdba;  border-color: #004144; font-weight: bold; text-align: left;"><%=flightNo_Dep%></td>
			<!--<td style="background-color:#f4d7e1;  border-color: #B93160; font-weight: bold; text-align: center;"><%=flightDescription_Dep%>&nbsp;&nbsp;&nbsp;</td>-->
			<td style="background-color:#3ddbd9;  border-color: #004144; font-weight: bold; text-align: center;"><%=firstPaxCheckTime_Dep%></td>
			<td style="background-color:#9ef0f0;  border-color: #004144; font-weight: bold; text-align: center;"><%=latestPaxCheckTime_Dep%></td>
			<td style="background-color:#d9fbfb;  border-color: #004144; font-weight: bold; text-align: right;font-size:16px;"><%=totalPaxChecked_Dep%>&nbsp;&nbsp;</td>
		</tr>
<%
	}
	rsTemp.close();
...
%>
		...
		<table id = "auto-index2" class="table table-sm table-striped">
			<thead>
			<tr id='head1'>
				<th colspan=4 style="font-family: Arial;background-color: #1192e8; color: white; font-size: 22px;text-align: left;">Agewise Statistics in last <%=displayHours%> hours</th>
				</tr>
			</thead>
		</table><br>
...
\			</tr>
	...
	<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center;height:20px;">
		...
		<td style="background-color:#ff888e;border-color: #da1e28;width:25%; font-weight: bold; text-align: right;"><%=weeklyM0_M6_Arr[i].equals("0") ? "&nbsp;" : weeklyM0_M6_Arr[i]%>&nbsp;&nbsp;</td>
		<td style="background-color:#ffb3b8;border-color: #da1e28;width:25%; font-weight: bold; text-align: right;"><%=weeklyM6_Y1_Arr[i].equals("0") ? "&nbsp;" : weeklyM6_Y1_Arr[i]%>&nbsp;&nbsp;</td>
		...
		<td style="background-color:#ffb3b8;border-color: #da1e28;width:25%; font-weight: bold; text-align: right;"><%=weeklyY5_Y10_Arr[i].equals("0") ? "&nbsp;" : weeklyY5_Y10_Arr[i]%>&nbsp;&nbsp;</td>
		...
		<td style="background-color:#ffb3b8;border-color: #da1e28;width:25%; font-weight: bold; text-align: right;"><%=weeklyY20_Y30_Arr[i].equals("0") ? "&nbsp;" : weeklyY20_Y30_Arr[i]%>&nbsp;&nbsp;</td>
		...
		<td style="background-color:#ffb3b8;border-color: #da1e28;width:25%; font-weight: bold; text-align: right;"><%=weeklyY40_Y50_Arr[i].equals("0") ? "&nbsp;" : weeklyY40_Y50_Arr[i]%>&nbsp;&nbsp;</td>
		...
		<td style="background-color:#ffb3b8;border-color: #da1e28;width:25%; font-weight: bold; text-align: right;"><%=weeklyY60_Y70_Arr[i].equals("0") ? "&nbsp;" : weeklyY60_Y70_Arr[i]%>&nbsp;&nbsp;</td>
		...
		<td style="background-color:#ffb3b8;border-color: #da1e28;width:25%; font-weight: bold; text-align: right;"><%=weeklyY80_Y90_Arr[i].equals("0") ? "&nbsp;" : weeklyY80_Y90_Arr[i]%>&nbsp;&nbsp;</td>
		...
		<td style="background-color:#ffb3b8;border-color: #da1e28;width:25%; font-weight: bold; text-align: right;"><%=weeklyY100_Arr[i].equals("0") ? "&nbsp;" : weeklyY100_Arr[i]%>&nbsp;&nbsp;</td>
	</tr>
<%
			}
			%>
...
<div class="card-body">
<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Agewise Statistics in last 7 days</h1>

		<canvas id="canvasWeeklyAgewise" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #f79bbe 100%);"></canvas>
	</div>
	</div>	
	</div>
	</div>
...
scales: {
		...
		var ctx = document.getElementById('canvasWeeklyAgewise').getContext('2d');
		var myCharts = new Chart(ctx, {
			type: 'bar',    	// Define chart type
			data: myData,    	// Chart data
			options: myoptions	// Chart Options [This is optional paramenter use to add some extra things in the chart].
	...
	<%//////////////////////	Pie - Agewise Statistics in Daily - Start	/////////////////////////////////

	String WeeklyArrAgewiseP = "";
	String WeeklyArrAgewiseXAxisP = "";
	int M0_M6_ArrP = 0;
	int M6_Y1_ArrP = 0;
	int Y1_Y5_ArrP = 0;
	int Y5_Y10_ArrP = 0;
	...
	StringBuilder weekDaysAgewiseP = new StringBuilder();
	StringBuilder weekM0_M6_ArrP = new StringBuilder();
	StringBuilder weekM6_Y1_ArrP = new StringBuilder();
	StringBuilder weekY1_Y5_ArrP = new StringBuilder();
	StringBuilder weekY5_Y10_ArrP = new StringBuilder();
	StringBuilder weekY10_Y20_ArrP = new StringBuilder();
	StringBuilder weekY20_Y30_ArrP = new StringBuilder();
	StringBuilder weekY30_Y40_ArrP = new StringBuilder();
	StringBuilder weekY40_Y50_ArrP = new StringBuilder();
	StringBuilder weekY50_Y60_ArrP = new StringBuilder();
	StringBuilder weekY60_Y70_ArrP = new StringBuilder();
	StringBuilder weekY70_Y80_ArrP = new StringBuilder();
	StringBuilder weekY80_Y90_ArrP = new StringBuilder();
	StringBuilder weekY90_Y100_ArrP = new StringBuilder();
	StringBuilder weekY100_ArrP = new StringBuilder();

	 flagFlightCountb = false;
	try {
		WeeklyArrAgewiseP = "select SUM(M0_M6) as M0_M6, SUM(M6_Y1) as M6_Y1,SUM(Y1_Y5) as Y1_Y5,SUM(Y5_Y10) as Y5_Y10,SUM(Y10_Y20) as Y10_Y20,SUM(Y20_Y30) as Y20_Y30,SUM(Y30_Y40) as Y30_Y40,SUM(Y40_Y50) as Y40_Y50,SUM(Y50_Y60) as Y50_Y60,SUM(Y60_Y70) as Y60_Y70,SUM(Y70_Y80) as Y70_Y80,  SUM(Y80_Y90) as Y80_Y90,  SUM(Y90_Y100) as Y90_Y100,  SUM(Y100) as Y100, icp_description,to_char(pax_boarding_date,'Mon-dd') as pax_boarding_date_2, pax_boarding_date,ICP_SRNO,sum(hourly_evisa_count) as sum_evisa_count, sum(hourly_voa_count) as sum_hourly_voa_count, sum(hourly_regular_visa_count) as hourly_regular_visa_count, sum(hourly_visa_exempted_count),sum(hourly_oci_count) as sum_hourly_oci_count,sum(hourly_foreigner_count), table_type from im_dashboard_combined where ICP_SRNO = '"+ filter_icp +"' and  pax_boarding_date = trunc(sysdate) and table_type='IM_TRANS_ARR_TOTAL'  group by pax_boarding_date,table_type,icp_description,ICP_SRNO order by pax_boarding_date";

		psTemp = con.prepareStatement(WeeklyArrAgewiseP);
		rsTemp = psTemp.executeQuery();
		while (rsTemp.next()) {

			WeeklyArrAgewiseXAxis = rsTemp.getString("pax_boarding_date_2");
			//out.println(weeklyVisaXAxis);
			M0_M6_ArrP = rsTemp.getInt("M0_M6");
			M6_Y1_ArrP = rsTemp.getInt("M6_Y1");
			Y1_Y5_ArrP = rsTemp.getInt("Y1_Y5");
			Y5_Y10_ArrP = rsTemp.getInt("Y5_Y10");
			Y10_Y20_ArrP = rsTemp.getInt("Y10_Y20");
			Y20_Y30_ArrP = rsTemp.getInt("Y20_Y30");
			Y30_Y40_ArrP = rsTemp.getInt("Y30_Y40");
			Y40_Y50_ArrP = rsTemp.getInt("Y40_Y50");
			Y50_Y60_ArrP = rsTemp.getInt("Y50_Y60");
			Y60_Y70_ArrP = rsTemp.getInt("Y60_Y70");
			Y70_Y80_ArrP = rsTemp.getInt("Y70_Y80");
			Y80_Y90_ArrP = rsTemp.getInt("Y80_Y90");
			Y90_Y100_ArrP = rsTemp.getInt("Y90_Y100");
			Y100_ArrP = rsTemp.getInt("Y100");
			//out.println(weeklyOCICount);

			if (flagFlightCountb == true) {
			  weekDaysAgewiseP.append(",");
			  weekM0_M6_ArrP.append(",");
			  weekM6_Y1_ArrP.append(",");
			  weekY1_Y5_ArrP.append(",");
			  weekY5_Y10_ArrP.append(",");
			  weekY10_Y20_ArrP.append(",");
			  weekY20_Y30_ArrP.append(",");
			  weekY30_Y40_ArrP.append(",");
			  weekY40_Y50_ArrP.append(",");
			  weekY50_Y60_ArrP.append(",");
			  weekY60_Y70_ArrP.append(",");
			  weekY70_Y80_ArrP.append(",");
			  weekY80_Y90_ArrP.append(",");
			  weekY90_Y100_ArrP.append(",");
			  weekY100_ArrP.append(",");
			...
			weekDaysAgewiseP.append("\"");
			weekDaysAgewiseP.append(WeeklyArrAgewiseXAxis);
			weekDaysAgewiseP.append("\"");
			
			weekM0_M6_ArrP.append(M0_M6_ArrP);
			weekM6_Y1_ArrP.append(M6_Y1_ArrP);
			weekY1_Y5_ArrP.append(Y1_Y5_ArrP);
			  weekY5_Y10_ArrP.append(Y5_Y10_ArrP);
			  weekY10_Y20_ArrP.append(Y10_Y20_ArrP);
			  weekY20_Y30_ArrP.append(Y20_Y30_ArrP);
			  weekY30_Y40_ArrP.append(Y30_Y40_ArrP);
			  weekY40_Y50_ArrP.append(Y40_Y50_ArrP);
			  weekY50_Y60_ArrP.append(Y50_Y60_ArrP);
			  weekY60_Y70_ArrP.append(Y60_Y70_ArrP);
			  weekY70_Y80_ArrP.append(Y70_Y80_ArrP);
			  weekY80_Y90_ArrP.append(Y80_Y90_ArrP);
			  weekY90_Y100_ArrP.append(Y90_Y100_ArrP);
			  weekY100_ArrP.append(Y100_ArrP);
	...
	String strWeekDaysAgewiseP = weekDaysAgewiseP.toString();
	String strweekM0_M6_ArrP = weekM0_M6_ArrP.toString();
	String strweekM6_Y1_ArrP = weekM6_Y1_ArrP.toString();
	String strweekY1_Y5_ArrP = weekY1_Y5_ArrP.toString();
	String strweekY5_Y10_ArrP = weekY5_Y10_ArrP.toString();
	String  strweekY10_Y20_ArrP = weekY10_Y20_ArrP.toString();
	String  strweekY20_Y30_ArrP = weekY20_Y30_ArrP.toString();
	 String strweekY30_Y40_ArrP = weekY30_Y40_ArrP.toString();
	 String strweekY40_Y50_ArrP = weekY40_Y50_ArrP.toString();
	String  strweekY50_Y60_ArrP = weekY50_Y60_ArrP.toString();
	 String strweekY60_Y70_ArrP = weekY60_Y70_ArrP.toString();
	 String strweekY70_Y80_ArrP = weekY70_Y80_ArrP.toString();
	 String strweekY80_Y90_ArrP = weekY80_Y90_ArrP.toString();
	 String strweekY90_Y100_ArrP = weekY90_Y100_ArrP.toString();
	 String strweekY100_ArrP = weekY100_ArrP.toString();
...
<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	...
	<script>
		...
		var myData = {
			labels: [<%=strWeekDaysAgewiseP%>,<%=strweekM0_M6_ArrP%>,<%=strweekM6_Y1_ArrP%>,<%=strweekY1_Y5_ArrP%>,],
			datasets: [{ 
				  label: "6 Months",
			      backgroundColor: "#377ff3",
			      borderColor: "#377ff3",
			      ...
			      data: [<%=strweekY100_ArrP%>]
			}circumference:100,rotation:270]};
...
<!--   ************************END TSC DIV************************END  TSC DIV****************END  TSC DIV********  -->
		<!--   ************************START BIOMETRIC DIV*******************START BIOMETRIC DIV*****************START BIOMETRIC DIV****************START BIOMETRIC DIV********  -->
		<section id="biometric_2"><br><br><br>
		<div class="pt-4" id="biometric_2">
		<table id = "auto-index9" class="table table-sm table-striped">
			<thead>
			<tr id='head1'>
