...
try {
	...
	icpValue.put("277","PORTBLAIR");  // PORT BLAIR SEAPORT
...
////////////////////	Arrival/Departure PAX Count	Tabs	/////////////////////////
	 ...
	 String default_yrs = request.getParameter("default_yrs") == null ? "All" : request.getParameter("default_yrs");
	 ...
	 String vishwaFilterYear = " where Year = " + default_yrs ;
	 if(default_yrs.equals("All")) vishwaFilterYear = "";
	 else vishwaFilterYear = " where Year = " + default_yrs ;

	 if(filter_icp.equals("All") && !default_yrs.equals("All")) {vishwaFilter = " where Year = " + default_yrs;}
	 if(!filter_icp.equals("All") && default_yrs.equals("All")) {vishwaFilter = " where ICP_SRNO = '" + filter_icp + "'";}
	 if(!filter_icp.equals("All") && !default_yrs.equals("All")) {vishwaFilter = " where ICP_SRNO = '" + filter_icp + "' and Year = " + default_yrs;}
...
%> 
			...
			<font face="Verdana" color="#347FAA" size="2"><b>&nbsp;&nbsp;Select Year&nbsp;&nbsp;</b>
			<select class="form-select-sm"  name="default_yrs">
			<option value="All" <%if(default_yrs.equals("All")){%> selected<%}%>>All Years</option>
			<option value="2009" <%if(default_yrs.equals("2009")){%> selected<%}%>>2009</option>
			<option value="2010" <%if(default_yrs.equals("2010")){%> selected<%}%>>2010</option>
			<option value="2011" <%if(default_yrs.equals("2011")){%> selected<%}%>>2011</option>
			<option value="2012" <%if(default_yrs.equals("2012")){%> selected<%}%>>2012</option>
			<option value="2013" <%if(default_yrs.equals("2013")){%> selected<%}%>>2013</option>
			<option value="2014" <%if(default_yrs.equals("2014")){%> selected<%}%>>2014</option>
			<option value="2015" <%if(default_yrs.equals("2015")){%> selected<%}%>>2015</option>
			<option value="2016" <%if(default_yrs.equals("2016")){%> selected<%}%>>2016</option>
			<option value="2017" <%if(default_yrs.equals("2017")){%> selected<%}%>>2017</option>
			<option value="2018" <%if(default_yrs.equals("2018")){%> selected<%}%>>2018</option>
			<option value="2019" <%if(default_yrs.equals("2019")){%> selected<%}%>>2019</option>
			<option value="2020" <%if(default_yrs.equals("2020")){%> selected<%}%>>2020</option>
			<option value="2021" <%if(default_yrs.equals("2021")){%> selected<%}%>>2021</option>
			<option value="2022" <%if(default_yrs.equals("2022")){%> selected<%}%>>2022</option>
			<option value="2023" <%if(default_yrs.equals("2023")){%> selected<%}%>>2023</option>
			<option value="2024" <%if(default_yrs.equals("2024")){%> selected<%}%>>2024</option>
			<option value="2025" <%if(default_yrs.equals("2025")){%> selected<%}%>>2025</option>
			</select>&nbsp;&nbsp;
