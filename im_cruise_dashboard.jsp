...
<div class="col-sm-4">
<div class="card"style="border: solid 3px #e81784; border-radius: 20px;height:300px;">
<div class="card-body" style="height:300px;">
 <canvas id="canvasPAX_Total" class="chart" style="max-width: 100%;background: linear-gradient(to bottom, #ffffff 20%, #ffe6ef 100%);border-radius: 20px;height:300px;"></canvas>
</div>
</div>
</div>
 <script>
...
<div class="col-sm-4">
<div class="card"style="border: solid 3px #776ab9; border-radius: 20px;height:300px;">
<div class="card-body" style="height:300px;">
 <canvas id="canvasCruiseCount" class="chart" style="max-width: 100%;background: linear-gradient(to bottom, #ffffff 20%, #e5e2f2 100%);border-radius: 20px;height:300px;"></canvas>
</div>
</div>
</div>
</div>
