...
<div class="col-sm-5">
	...
	<canvas id="canvasPAX_icp" class="chart" style="max-width: 100%;border-radius: 20px;width:1200px;"></canvas><br>
</div>
	</div>
	</div>
	</div>
...
<div class="container-fluid">
	...
	<div class="card" style="border: solid 3px #776ab9; border-radius: 20px; height:550px;width:1300px;">
	<div class="card-body" style="height:550px; width:1300px;">
		...
		<canvas id="canvasPAX_nality" class="chart" style="max-width: 100%;border-radius: 20px;  background: linear-gradient(to bottom, #ffffff 35%, # 100%);height:550px;" ></canvas><br>
	</div>
	</div>
	</div>
	</div>
