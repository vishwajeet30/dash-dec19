...
try {
	...
	strSql5 = "SELECT NALTY_CODE, NALTY_DESC FROM IM_COUNTRY where NALTY_CODE in (select NALTY_CODE from IM_DASHBOARD_EVISA_ICP) order by NALTY_CODE";
	try
	{
		rs5 = stmt5.executeQuery(strSql5);
	}
...
function compare_report()
{
	...
	document.entryfrm.action="im_evisa_dashboard.jsp?&icp="+document.entryfrm.compare_icp.value;
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<img src="e-VISA.png" width="100%" height="90%" alt="e-Visa Dashboard" align="center;">
				</div>
		...
		<div class="container"> 
		  ...
		  <div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav">
			  ...
			  <li class="nav-item dropdown"><a href="#Home" class="scrollLink nav-link dropdown-toggle" data-toggle="dropdown">e-Visa</a>
			  <ul class="dropdown-menu">
			  <li> <a class="scrollLink dropdown-item" href="#ICP_1">All ICPs Arrival and Departure e-Visa Statistics</a></li>
			  <li> <a class="scrollLink dropdown-item" href="#ICP_2">ICP-wise Arrival and Departure e-Visa Statistics</a></li>
			  <li> <a class="scrollLink dropdown-item" href="#ICP_3">Country-wise Arrival and Departure e-Visa Statistics</a></ul></li>
...
*/
	...
	try {
		dashQuery = "select SUM(EVISA_PAX) from IM_DASHBOARD_EVISA_ICP" + vishwaFilter;
		psTemp = con.prepareStatement(dashQuery);
		rsTemp = psTemp.executeQuery();
		while(rsTemp.next()) {

	     total_Arrival_Count = total_Arrival_Count+rsTemp.getInt("SUM(EVISA_PAX)");
	...
	try {
		dashQuery = "select count(1) as arr_epassport from IM_TRANS_ARR_TOTAL where PAX_BOARDING_DATE = trunc(sysdate-1) and VISA_NO like '9%' " + vishwaFilter ;
		psTemp = con.prepareStatement(dashQuery);
		rsTemp = psTemp.executeQuery();
		if (rsTemp.next()) {
	...
	try {
		dashQuery = "select count(1) as arr_epassport from IM_TRANS_ARR_TOTAL where PAX_BOARDING_DATE = trunc(sysdate) and VISA_NO like '9%' " + vishwaFilter ;
		psTemp = con.prepareStatement(dashQuery);
		rsTemp = psTemp.executeQuery();
		if (rsTemp.next()) {
...
<div class="col-sm-3" style=" margin: auto;">
	<table class="tableDesign" width="50px">
		<tr style="font-size: 40px;  text-align: right; color:white; border-color: #bae6ff;height:20px; ">
			<th colspan="2" style="text-align: center;background-color:#004076;border-color: #004076;width:40%;text-align: center;font-size: 35px;">Arrival&nbsp;e&#8209;Visa</th>
		</tr>
		<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
			...
			<td style="background-color:#bae6ff;border-color: #bae6ff;width:50%; font-weight: bold;text-align: left;color: #004076;">&nbsp;Today's&nbsp;e&#8209;Visa</td>
		</tr>
		<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
			...
			<td style="background-color:#bae6ff;border-color: #bae6ff;width:50%; font-weight: bold;text-align: left;color :#0072d3">&nbsp;Yesterday's&nbsp;e&#8209;Visa</td>
		</tr>
		<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
			...
			<td style="background-color:#bae6ff;border-color: #bae6ff;width:50%; font-weight: bold;text-align: left;color: #44a9ff;">&nbsp;Total&nbsp;e&#8209;Visa</td>
		</tr>
	</table>
</div>
<%/////////////////////////////////////////////////////////////
...
%>
	...
	<table id = "auto-index1" class="table table-sm table-striped" >
			<thead>
				...
				<tr id='head1'>
				<%if(filter_icp.equals("All")) {%>	
					<th colspan=4 style="font-family: Arial;background-color: #1192e8; color: white; font-size: 20px;text-align: left;">All ICPs Arrival e-Visa Statistics</th>
				<%} else {%>
					<th colspan=4 style="font-family: Arial;background-color: #1192e8; color: white; font-size: 20px;text-align: left;"><%=capitalizeFirstChar(dash.replace("INTERNATIONAL",""))%> : Arrival e-Visa Statistics</th>
				<%} %>
				</tr>
	...
	<div class="col-sm-3" style="flex:1;">
		<table class="tableDesign" >
			...
			<tr style="font-size: 15px;  text-align: right; color:white; border-color: #009688;height:12px;">
				...
				<th style="text-align: center;background-color:#007d79;border-color: #005555;width:33.33%; text-align: right;">Arrival&nbsp;e&#8209;Visa&nbsp;</th>
			</tr>
<%
...
try
	{
	SQLQUERY = "";
	SQLQUERY = "select year as arr_year,sum(EVISA_PAX) as arr_count,sum(EVISA_PAX) as dep_count from IM_DASHBOARD_EVISA_ICP "+ vishwaFilter +" group by year order by 1 desc";
	...
	maintainAspectRatio:false,
		responsive:true,
			 scales: {
				 ...
				 title: {
						display: true,
							text:'Arrival e-Visa Statistics',
						fontSize: 25,		
					  },
		tooltips: {
			enabled: true
			...
			var chartInstances = this.chart,
				...
				this.data.datasets.forEach(function (dataset, i) {
					...
					metas.data.forEach(function (bar, index) {
						...
						ctx.fillText(data.toLocaleString('en-IN'), bar._model.x+30, bar._model.y+5);
					});
				});
			}
		},
...
<table id = "auto-index1" class="table table-sm table-striped">
	<thead>
		<tr id='head1'>
			<th colspan="4" style="font-family: Arial;background-color: #1192e8; color: white; font-size: 22px;text-align: left;">ICP-wise Arrival e-Visa Statistics</th>
		</tr>
	</thead>
</table><br>
...
try
	...
	SQLQUERY = " select ICP_SRNO,sum(EVISA_PAX) as arr_count,sum(EVISA_PAX) as dep_count from IM_DASHBOARD_EVISA_ICP "+ vishwaFilter +" group by ICP_SRNO order by 2 desc";
			...
			if(srno%17 == 0)
			{
				...
				<td>
					<div class="col-sm-2">
						...
						<tr style="font-size: 15px;  text-align: right; color:white; border-color: #c10065;height:12px;background-color:#ed459d;">
							<th style="background-color:#ed459d;border-color: #c10065;text-align: center; width:10%;">S.No.</th>
							<th style="background-color:#ed459d;border-color: #c10065;text-align: left;width:20%;">ICP</th>
							<th style="background-color:#ed459d;border-color: #c10065; text-align: right;width:22%;">Arrival&nbsp;e&#8209;Visa&nbsp;</th>
						</tr>
<% 
					}
%>						<tr style="font-size: 14px;color:black; font-family: 'Arial', serif; border-color: #ed459d;height:18px;">
						...
						<td style="background-color:#fdeef6;border-color:#f6a2ce; font-weight: bold;text-align: left;width:20%;"><%=icpValue.get(rsTemp.getString("ICP_SRNO")) == null ? rsTemp.getString("ICP_SRNO"):icpValue.get(rsTemp.getString("ICP_SRNO")).replace(" ", "&nbsp;").replace("-", "&#8209;")%></td>
...
<%
				...
				while(srno%17!=0)
				{
					...
					{
%>						<tr style="font-size: 15px;  text-align: right; color:white; border-color: #c10065;height:12px;background-color:#ed459d;">
						<td colspan="2" style="background-color:#ed459d;border-color:#c10065; font-weight: bold;text-align: left;width:20%;text-align: center;">Total&nbsp;</td>
						<td style="background-color:#ed459d;border-color:#c10065; font-weight: bold; text-align: right;width:22%;"><%=getIndianFormat(ePass_Arr_Total)%>&nbsp;</td>
					</tr>
<%					} 
					else 
					{ 
...
<div class="card-body" style="height:1100px;">		
  <canvas id="canvasPAX_icp" class="chart" style="max-width: 100%;border-radius: 20px;background: linear-gradient(to bottom, #ffffff 50%, #ffe9f1 100%);"></canvas><br>
</div>
</div>
</div>
</div>
		...
		var myoptionsp = {
			...
			maintainAspectRatio: false,
				 scales: {
					  ...
					  title: {
							display: true,
								text: 'Top 20 : ICP-wise Arrival e-Visa Statistics',
							fontSize: 25,
			...
			onComplete: function () {
				var chartInstances = this.chart,
					...
					this.data.datasets.forEach(function (dataset, i) {
						...
						metas.data.forEach(function (bar, index) {
							var data = dataset.data[index];
							ctx.fillText(data.toLocaleString('en-IN'), bar._model.x+27, bar._model.y+6);
...
<table id = "auto-index1" class="table table-sm table-striped" >
	<thead>
		<tr id='head1'>
			<%if(filter_icp.equals("All")) {	%>	
				<th colspan="4" style="font-family: Arial;background-color: #1192e8; color: white; font-size: 22px;text-align: left;">All ICPs : Country-wise Arrival e-Visa Statistics</th>
			<%} else {%>
				<th colspan="4" style="font-family: Arial;background-color: #1192e8; color: white; font-size: 22px;text-align: left;"><%=capitalizeFirstChar(dash.replace("INTERNATIONAL",""))%> : Country-wise Arrival e-Passport Statistics</th>
			<%} %>
		</tr>
...
try
	...
	SQLQUERY = "select NALTY_CODE,sum(EVISA_PAX) as arr_count,sum(EVISA_PAX) as dep_count from IM_DASHBOARD_EVISA_NALTY " + vishwaFilter + " group by NALTY_CODE order by 2 desc";
	...
	PreparedStatement psTempEvisaCountry = null;
	ResultSet rsTempEvisaCountry = null;

	String sqlEvisaCountry = "";
	String eVisaCountry = "N";

	String backGroundColor = "#efedf6";

	LinkedHashMap<String,String> pinkColoredCountryPair = new LinkedHashMap<String,String>();
	...
	while (rsTemp.next()) {
		...
		sqlEvisaCountry = "select VISA_FREE from IM_COUNTRY where NALTY_CODE = '" + rsTemp.getString("NALTY_CODE") + "'";
		//SQLQUERY = "select NALTY_CODE,sum(ARRIVAL_PAX) as arr_count,sum(DEPARTURE_PAX) as dep_count from IM_DASHBOARD_EPASSPORT_NALTY where ICP_SRNO = '004' and NALTY_CODE = 'USA' group by NALTY_CODE order by 2 desc";
		
		psTempEvisaCountry = con.prepareStatement(sqlEvisaCountry);
		rsTempEvisaCountry = psTempEvisaCountry.executeQuery();
	
		if(rsTempEvisaCountry.next()){
			eVisaCountry = rsTempEvisaCountry.getString("VISA_FREE");
		}

		if(rsTempEvisaCountry!=null)
		{
			rsTempEvisaCountry.close();
			psTempEvisaCountry.close();
		}
		
		if(!eVisaCountry.equals("Y"))
		{
			backGroundColor = "lightpink";

			country_Arr_Total = country_Arr_Total + rsTemp.getInt("arr_count");
			pinkColoredCountryPair.put(naltyValue.get(rsTemp.getString("NALTY_CODE")) == null ? rsTemp.getString("NALTY_CODE") : naltyValue.get(rsTemp.getString("NALTY_CODE")).replace(" ", "&nbsp;").replace("-", "&#8209;")+ "####" + rsTemp.getString("NALTY_CODE"),rsTemp.getInt("arr_count") == 0 ? "&nbsp;" : getIndianFormat(rsTemp.getInt("arr_count")));
		...
		////////////////////////////////////////
			...
			if(srno%17 == 0)
			{
				...
				<div class="col-sm-2" >
				<table class="tableDesign">
			<tr style="font-size: 15px;   color:white; border-color: #382497;height:12px;border-radius: 20px;">
				<th style="background-color:#6D5EB4;border-color: #382497; text-align: center;width:10%;">S.No.</th>
				<th style="background-color:#6D5EB4;border-color: #382497; text-align: left;width:15%;">Country</th>
				<th style="background-color:#6D5EB4;border-color: #382497; text-align: right;width:25%;">Arrival&nbsp;e&#8209;Visa&nbsp;</th>
			</tr>
			<%
			}
			...
			<tr style="font-size: 14px;color:black; font-family: 'Arial', serif; border-color: #6929c4;height:18px;">
				<td style="background-color:<%=backGroundColor%>;border-color:#776ab9;width:10%; font-weight: bold;text-align: center;"><%=++srno%></td>
				<td style="background-color:<%=backGroundColor%>;border-color:#776ab9;width:15%; font-weight: bold;text-align: left;"><%=naltyValue.get(rsTemp.getString("NALTY_CODE")) == null ? rsTemp.getString("NALTY_CODE") : naltyValue.get(rsTemp.getString("NALTY_CODE")).replace(" ", "&nbsp;").replace("-", "&#8209;")%>&nbsp;</td>
				<td style="background-color:<%=backGroundColor%>;border-color:#776ab9;width:25%; font-weight: bold; text-align: right;"><%=rsTemp.getInt("arr_count") == 0 ? "&nbsp;" : getIndianFormat(rsTemp.getInt("arr_count"))%>&nbsp;</td>
			</tr>
<%
				/*country_Arr_Total = country_Arr_Total + rsTemp.getInt("arr_count");
				country_Dep_Total = country_Dep_Total + rsTemp.getInt("dep_count");
	...
	//////////////////////////////////////////////////////////// Start : Pink Colored Country Printing /////////////////////////////////////////////////////
	//out.println(pinkColoredCountryPair);

	ArrayList<String> greenCountries  = new ArrayList<String>();
	greenCountries.add("CHN");
	greenCountries.add("IRN");
	greenCountries.add("QAT");
	greenCountries.add("HKG");

	for (String key: pinkColoredCountryPair.keySet()) {
		...
		sqlEvisaCountry = "select VISA_FREE from IM_COUNTRY where NALTY_CODE = '" + key.split("####")[1] + "'";
		//SQLQUERY = "select NALTY_CODE,sum(ARRIVAL_PAX) as arr_count,sum(DEPARTURE_PAX) as dep_count from IM_DASHBOARD_EPASSPORT_NALTY where ICP_SRNO = '004' and NALTY_CODE = 'USA' group by NALTY_CODE order by 2 desc";
		...
		////////////////////////////////////// Start : Green Countries ///////////////////////////////////////////
		
		if(greenCountries.contains(key.split("####")[1]))
		{
		...
		////////////////////////////////////////
			...
			<tr style="font-size: 14px;color:black; font-family: 'Arial', serif; border-color: #6929c4;height:18px;">
				<td style="background-color:<%=backGroundColor%>;border-color:#776ab9;width:10%; font-weight: bold;text-align: center;"><%=++srno%></td>
				<td style="background-color:<%=backGroundColor%>;border-color:#776ab9;width:15%; font-weight: bold;text-align: left;"><%=key.split("####")[0]%>&nbsp;</td>
				<td style="background-color:<%=backGroundColor%>;border-color:#776ab9;width:25%; font-weight: bold; text-align: right;"><%=pinkColoredCountryPair.get(key)%>&nbsp;</td>
			</tr>
<%
				/*country_Arr_Total = country_Arr_Total + rsTemp.getInt("arr_count");
				country_Dep_Total = country_Dep_Total + rsTemp.getInt("dep_count");
	...
	//////////////////////////////////////////////////////////// End : Pink Colored Country Printing /////////////////////////////////////////////////////
				...
				{	
					...
					if(whileCounter == 1)
					{
%>						<tr style="font-size: 15px;  text-align: right; color:white; border-color: #382497;height:12px;background-color:#ed459d;">
							<td colspan="2" style="background-color:#6D5EB4;border-color:#382497; font-weight: bold;text-align: left;width:20%;text-align: center;">Total&nbsp;</td>
							<td style="background-color:#6D5EB4;border-color:#382497; font-weight: bold; text-align: right;width:22%;"><%=getIndianFormat(country_Arr_Total)%>&nbsp;</td>
						</tr>
<%					} 
					else 
					{ 
...
<div class="card" style="border: solid 3px #776ab9; border-radius: 20px; height:550px;">
<div class="card-body" style="height:550px;">
<canvas id="canvasPAX_nality" class="chart" style="max-width: 100%;border-radius: 20px;  background: linear-gradient(to bottom, #ffffff 50%, #e5e2f2 100%);height:550px;" ></canvas><br>
</div>
</div>
</div>
</div>
...
*/
				...
				maintainAspectRatio: false,
				 scales: {
					 ...
					 title: {
							display: true,
								text: 'Top 20 : Country-wise Arrival e-Visa Statistics',
								fontSize:25,
							},
			tooltips: {
				enabled: true
