...
///////////////////////////////////////// Start : Cliet Ip Retrival /////////////////////////////////////////////////////
				...
				ipToIcpMapping.put("10.52.158.36","008#022#004");
				ipToIcpMapping.put("10.52.158.441","016#008");
				ipToIcpMapping.put("10.52.158.44","004#008#016#006");
...
//|| !ipToIcpMapping.get(Client_IP).contains("004")
	...
	{
		%>
			<jsp:forward page="im_dashboard_logout.jsp" />
		<%
	}
...
<div class="col-sm-12">
	<table class="tableDesign">
		<tr style="font-size: 45px;  text-align: right; color:white; border-color: #bae6ff;height:20px; ">
			<th  style="text-align: center;background-color:#8d0d13;border-color: #8d0d13;width:40%;text-align: center;">You are not authorised to access this Dashboard</th>
		</tr>
		<tr style="font-size: 25px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
			<td style="background-color:#ffd7d9;border-color: #ffd7d9;width:50%; font-weight: bold;text-align: center;color: #750e13;">(Client IP : <%=Client_IP%>)</td>
		</tr>
	</table>
	...
	<table class="tableDesign">
		...
		<tr style="font-size: 25px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
			<td style="background-color:#ffffff;border-color: #ffffff;width:50%; font-weight: bold;text-align: center;color: #750e13;">	 <a href="http://10.248.168.222:8888/Imm/icp_dashboard/im_icp_dashboard_00.jsp" target="_blank" ><button class="btn btn-primary btn-md" type="button"> Home</button></a></td>
		</tr>
	</table>
</div>
<%////////////////////////////////////////////////////////////////////////////////%>
