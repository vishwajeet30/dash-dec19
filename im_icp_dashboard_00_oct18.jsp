...
<script LANGUAGE="JAVASCRIPT">
	...
	function DigitalTime()
	{
		...
		var digclock = "<font size='2' face='Arial' color='black'><b>" + "<font size='2'>&nbsp;Date : </font>" +  dayarray[DigitalClock.getDay()] + ", " + montharray[DigitalClock.getMonth()] + " " + date + ", " + DigitalClock.getYear()  + "<BR>" + "<font size='2'>&nbsp;Time : </font>" + hours + ":" + minutes + ":" + seconds + " " + dn +  "<BR><font size='2' color='black'>&nbsp;(" + document.entryfrm.ReverseCounterID.value + "</b> seconds left to refresh)</font></font>";
...
<!-- End :  Reverse Timer Functions -->
		...
		<body onload="DigitalTime(); StartTimer();" style="background-color: #fff;">
		<div class="wrapper">
		<SPAN id="Clock" style="position:absolute;top:10px;width:250px;height:500px;" ></span>
