...
<div class="col-sm-3">
	<table class="tableDesign" width="50px">
		...
		<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
			<td id="count_total_Camera_Count" colspan="2" style="background-color:#bae6ff;border-color: #bae6ff;width:50%; font-weight: bold; text-align: center;font-size: 30px;color: #44a9ff;"></td>
...
<div class="col-sm-3">
	<table class="tableDesign">		
		...
		<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
			<td id="count_total_Passport_Count" colspan="2" style="background-color:#e8daff;border-color: #e8daff;width:50%; font-weight: bold; text-align: center;font-size: 30px;color: #a376e2;"></td>
...
<div class="col-sm-3">
	<table class="tableDesign" width="50px">
		<tr style="font-size: 40px;  text-align: right; color:white; border-color: #bae6ff;height:20px; ">
			<th colspan="2" style="text-align: center;background-color:#004076;border-color: #004076;width:40%;text-align: center;font-size: 35px;">D/E&nbsp;Card&nbsp;Images</th>
		</tr>
		<!-- <tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
		...
		<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
			<td id="total_DECard_Count_ID" colspan="2" style="background-color:#bae6ff;border-color: #bae6ff;width:50%; font-weight: bold; text-align: center;font-size: 30px;color: #44a9ff;"></td>
...
<div class="col-sm-3">
	<table class="tableDesign">		
		<tr style="font-size: 40px;  text-align: right; color:white; border-color: #6929c4;height:20px;">
			<th colspan="2" style="text-align: center;background-color:#5521a0;border-color: #5521a0;width:40%; text-align: center;font-size: 35px;">Visa&nbsp;Images</th>
		</tr>
		<!-- <tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
		...
		<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
			<td id="total_Visa_Count_ID" colspan="2" style="background-color:#e8daff;border-color: #e8daff;width:50%; font-weight: bold; text-align: center;font-size: 30px;color: #a376e2;"></td>
...
%>
	...
	<%////////////////////////////////////////////// All ICPs Arrival and Departure e-Passport Statistics /////////////////////////////////////////%>
		<section id="ICP_1">
		<div class="pt-4" id="ICP_1"><br><br><br><br><br><br>
	<table id = "auto-index1" class="table table-sm table-striped" >
			<thead>

				<tr id='head1'>
				<%if(filter_icp.equals("All")) {%>	
					<th colspan=4 style="font-family: Arial;background-color: #1192e8; color: white; font-size: 20px;text-align: left;">All ICPs Camera, Passport, D/E Card and Visa Image Statistics</th>
				<%} else {%>
					<th colspan=4 style="font-family: Arial;background-color: #1192e8; color: white; font-size: 20px;text-align: left;"><%=capitalizeFirstChar(dash.replace("INTERNATIONAL",""))%> : Camera, Passport, D/E Card and Visa Image Statistics</th>
				<%} %>
				</tr>
	...
	<div class="col-sm-3">
		<table class="tableDesign">
			...
			<tr style="font-size: 15px;  text-align: right; color:white; border-color: #009688;height:12px;">
				...
				<th style="text-align: center;background-color:#007d79;border-color: #005555;width:33.33%; text-align: right;">D/E&nbsp;Card&nbsp;Images&nbsp;</th>
				<th style="text-align: center;background-color:#007d79;border-color: #005555;width:33.33%; text-align: right;">Visa&nbsp;Images&nbsp;</th>
...
&nbsp;&nbsp;&nbsp;&nbsp;
<div class="col-sm-6">
<div class="card"style="border: solid 3px #007d79; border-radius: 20px;  width:900px" >
<div class="card-body" style="height:1700px; width:900px;">
	...
	var myoptions = {
			maintainAspectRatio: false,
			 scales: {
				 ...
				 title: {
						display: true,
							text:'Camera, Passport, D/E Card and Visa Image Statistics',
						fontSize: 25,		
					  },
		tooltips: {
			enabled: true
...
try
	...
	while (rsTemp.next()) {
			/*if(rsTemp.getInt("arr_year") < 2005 ) 
		{
			...
			IcpPax.append("\"");
			IcpPax.append(",");
			ICP_Camera.append(rsTemp.getInt("camera_count")+ " Camera" +",");
				...
				<td>
					<div class="col-sm-4" style="width:750px;">
						...
						<tr style="font-size: 15px;  text-align: right; color:white; border-color: #3B7DD8;height:12px;background-color:#ed459d;">
							...
							<th style="background-color:#ed459d;border-color: #f6a2ce; text-align: right;width:23%;">D/E&nbsp;Card&nbsp;Images&nbsp;</th>
							<th style="background-color:#ed459d;border-color: #f6a2ce; text-align: right;width:23%;">Visa&nbsp;Images&nbsp;</th>
			...
			onComplete: function () {
				var chartInstances = this.chart,
					...
					this.data.datasets.forEach(function (dataset, i) {
						...
						metas.data.forEach(function (bar, index) {
							var data = dataset.data[index];
							ctx.fillText(data, bar._model.x+37, bar._model.y+6);
