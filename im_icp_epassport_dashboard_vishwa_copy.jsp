...
<script LANGUAGE="JAVASCRIPT">
	...
	function DigitalTime()
	{
		...
		var digclock = "<font size='1' face='Verdana' color='darkgreen'>" + "<font size='1'>&nbsp;Date : </font>" +  dayarray[DigitalClock.getDay()] + ", " + montharray[DigitalClock.getMonth()] + " " + date + ", " + y1 + "<BR>" + "<font size='1'>&nbsp;Time : </font>" + hours + ":" + minutes + ":" + seconds + " " + dn +  "<BR><font size='1' color='red'>&nbsp;(auto refresh in " + document.entryfrm.ReverseCounterID.value + " seconds)</font></font>";
...
<body onload="DigitalTime(); StartTimer();">
	<div class="wrapper">
	<SPAN id="Clock" style="position:absolute;top:20px;width:250px;height:500px;" ></span>
