			...
			<div class="container"> 
			  ...
			  <div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav">
				  ...
				  <li> <a class="scrollLink dropdown-item" href="#ICP_1">Arrival and Departure e-Passport Processed in last 7 days</a> </li>
				  <li> <a class="scrollLink dropdown-item" href="#ICP_2">Year-wise Arrival and Departure e-Passport Statistics</a></ul></li>
...
<%//================================================
	...
	try {
		dashQuery = "select ARRIVAL_PAX from IM_DASHBOARD_EPASSPORT_ICP where ICP_SRNO = '" + filter_icp + "'";
		psTemp = con.prepareStatement(dashQuery);
		rsTemp = psTemp.executeQuery();
		while(rsTemp.next()) {

	     total_Arrival_Count = total_Arrival_Count+rsTemp.getInt("ARRIVAL_PAX");
...
<div class="col-sm-3">
		...
		<section id="ICP_1"><br><br><br><br><br>
		<div class="pt-4" id="ICP_1">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	var myData = {
		...
		var myoption = {
				 scales: {
					 ...
					 title: {
						display: true,
							text: 'Arrival and Departure e-Passport Processed in last 7 days',
					        fontSize: 22,		
					      },
			tooltips: {
				enabled: true
	...
	<%///////////////////////////	  Year-wise Arrival and Departure e-Passport Statistics - Start	///////////////////////////////%>
		...
		<section id="ICP_2"><br><br><br><br><br>
		<div class="pt-4" id="ICP_2">
		<table id = "auto-index1" class="table table-sm table-striped" >
			<thead>
				<tr id='head1'>
...
<%  
	...
	<%///////////////////////	Table -  Arrival and Departure Immigration Clearance in last 7 days - End	////////////////////////%>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<div class="col-sm-7" style="height:800px; width:1000px;">
	<div class="card"style="border: solid 3px #B93160; border-radius: 20px;height:800px;width:1000px;">
	<div class="card-body" style="height:800px;width:1000px">
		<!--<h1 style="font-size: 20px; color: black;font-weight: bold; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif; background-color: #ffffff;height:30px;">Year-wise Arrival and Departure e-Passport Statistics</h1>-->
	...
	<script>
		...
		var myoptions = {
				 ...
				 scales: {
					 ...
					 title: {
							display: true,
								text: 'Year-wise Arrival and Departure e-Passport Statistics',
					        fontSize: 22,		
					      },
			tooltips: {
				enabled: true
			...
			onComplete: function () {
				var chartInstances = this.chart,
					...
					this.data.datasets.forEach(function (dataset, i) {
						...
						metas.data.forEach(function (bar, index) {
							var data = dataset.data[index];
							ctx.fillText(data, bar._model.x+29, bar._model.y+5);
