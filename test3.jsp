...
<script>
		function compare_report()
		{
				...
				document.entryfrm.action="test3.jsp?&icp="+document.entryfrm.compare_icp.value;
		...
		function compare_hrs()
		{
				...
				document.entryfrm.action="test3.jsp?&icp="+document.entryfrm.compare_icp.value+"&default_hrs="+document.entryfrm.default_hrs.value;
				document.entryfrm.submit();
				return true;
		...
		<header class="bg-white py-1">
		  <div class="container">
			<div class="row">
			  <div class="col-sm-4">
				<a href="../OCI-html/index.html"><h1><span>IVFRT (I)</span><br/>National Informatics Centre</h1></a>
			  </div>
			  <!--<div class="col-sm-8">
				...
				var chartInstances = this.chart,
					...
					this.data.datasets.forEach(function (dataset, i) {
						...
						metas.data.forEach(function (bar, index) {
							...
							ctx.fillText(data, bar._model.x+1, bar._model.y+1);
...
<h1 style="font-size: 20px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Age-wise Statistics in last 7 days</h1>
		...
		<canvas id="canvasWeeklyAgewise2" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #f79bbe 100%);"></canvas>
	</div>
	</div>	
	</div>
	</div>
...
<div class="container-fluid">
	...
	<table class="tableDesign">
		<!--<caption style="font-size: 22px; color: grey; line-height: 50px; text-align: center; padding-top: 5px;font-weight: bold; font-family: 'Arial', serif;">Types of Visa in last 7 days</caption>-->
				...
				<tr style="font-size: 15px;  text-align: right; color:white; height:40px;">
		...
		<% 
			...
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center;height:20px;">
				...
				<td style="background-color:#FFCCD5;border-color: #590D22;  font-weight: bold; text-align: right;color:#A4133C;font-size: 15px;"><%=(Integer.parseInt(UcfExistsIndWeekly[i]) + Integer.parseInt(UcfNotExistsIndWeekly[i]))  == 0 ? "&nbsp;" : (Integer.parseInt(UcfExistsIndWeekly[i]) + Integer.parseInt(UcfNotExistsIndWeekly[i]))%>&nbsp;&nbsp;</td>
				...
				<td style="background-color:#A9D6E5;border-color: #013A63;  font-weight: bold; text-align: right;color:#014F86;font-size: 15px;"><%=(Integer.parseInt(UcfExistsIndWeekly_Dep[i]) + Integer.parseInt(UcfNotExistsIndWeekly_Dep[i]))  == 0 ? "&nbsp;" : (Integer.parseInt(UcfExistsIndWeekly_Dep[i]) + Integer.parseInt(UcfNotExistsIndWeekly_Dep[i]))%>&nbsp;&nbsp;</td>
...
<%
	...
	<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Arrival : Indian UCF Matched/Not Matched Statistics in last 7 days</h1>
		...
		<canvas id="canvasWeeklyUcf" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #f6b3c5 100%);"></canvas>
	</div>
	</div>
	</div>
	...
	<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Departure : Indian UCF Matched/Not Matched Statistics in last 7 days</h1>
		...
		<canvas id="canvasWeeklyUcfDep" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #bae6ff 100%);"></canvas>
	</div>
	</div>
	</div>
	</div>
	...
	<table class="tableDesign">
		<!--<caption style="font-size: 22px; color: grey; line-height: 50px; text-align: center; padding-top: 5px;font-weight: bold; font-family: 'Arial', serif;">Types of Visa in last 7 days</caption>-->
				...
				<tr style="font-size: 14px;  text-align: right; color:white; border-color: #004144;height:40px;">
					...
					<th colspan="3" style="text-align: center;background-color:#004144;border-color: #004144; text-align: center;">Arrival&nbsp;UCF</th>
					<th colspan="3" style="text-align: center;background-color:#491D8B;border-color: #491D8B; text-align: center;">Departure&nbsp;UCF</th>
				</tr>
				<tr style="font-size: 14px;  text-align: right; color:white; border-color: #003a6d;height:40px;">
		...
		<% 
			...
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center;height:20px;">
				...
				<td style="background-color:#08bdba;border-color: #004144;  font-weight: bold; text-align: right;"><%=UcfExistsIndWeekly_F_Arr[i].equals("0") ? "&nbsp;" : UcfExistsIndWeekly[i]%>&nbsp;&nbsp;</td>
				<td style="background-color:#3ddbd9;border-color: #004144;  font-weight: bold; text-align: right;"><%=UcfNotExistsIndWeekly_F_Arr[i].equals("0") ? "&nbsp;" : UcfNotExistsIndWeekly[i]%>&nbsp;&nbsp;</td>
				<td style="background-color:#9ef0f0;border-color: #004144;  font-weight: bold; text-align: right;"><%=(Integer.parseInt(UcfExistsIndWeekly_F_Arr[i]) + Integer.parseInt(UcfNotExistsIndWeekly_F_Arr[i]))  == 0 ? "&nbsp;" : (Integer.parseInt(UcfExistsIndWeekly_F_Arr[i]) + Integer.parseInt(UcfNotExistsIndWeekly_F_Arr[i]))%>&nbsp;&nbsp;</td>


				<td style="background-color:#BE95FF;border-color: #491D8B;  font-weight: bold; text-align: right;"><%=UcfExistsIndWeekly_F_Dep[i].equals("0") ? "&nbsp;" : UcfExistsIndWeekly_F_Dep[i]%>&nbsp;&nbsp;</td>
				<td style="background-color:#d4bbff;border-color: #491D8B;  font-weight: bold; text-align: right;"><%=UcfNotExistsIndWeekly_F_Dep[i].equals("0") ? "&nbsp;" : UcfNotExistsIndWeekly_F_Dep[i]%>&nbsp;&nbsp;</td>
				<td style="background-color:#e8daff;border-color: #491D8B;  font-weight: bold; text-align: right;"><%=(Integer.parseInt(UcfExistsIndWeekly_F_Dep[i]) + Integer.parseInt(UcfNotExistsIndWeekly_F_Dep[i]))  == 0 ? "&nbsp;" : (Integer.parseInt(UcfExistsIndWeekly_F_Dep[i]) + Integer.parseInt(UcfNotExistsIndWeekly_F_Dep[i]))%>&nbsp;&nbsp;</td>
...
<%
	...
	<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Arrival : Foreigner UCF Matched/Not Matched Statistics in last 7 days</h1>
		...
		<canvas id="canvasWeeklyUcfForeignerArr" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #9ef0f0 100%);"></canvas>
	</div>
	</div>
	</div>
	...
	<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Departure : Foreigner UCF Matched/Not Matched Statistics in last 7 days</h1>
		...
		<canvas id="canvasWeeklyUcfForeignerDep" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #d4bbff 100%);"></canvas>
	</div>
	</div>
	</div>
	</div>
...
<%//////////////////////////////////////	Types of Foreigner UCF in last 7 days - End	/////////////////////////////////%>
	...
	<!--   ************************START Custom APIS DIV*******************START Custom APIS DIV*****************START Custom APIS DIV****************START UCF DIV********  -->
		<section id="Future"><br><br><br><br><br><br><br>
		<div class="pt-4" id="ucf_Foreigner">    
		<table id = "auto-index5" class="table table-sm table-striped">
			<thead>
			<tr id='head1'>
					<th style="font-family: Arial;background-color: #1192e8; color: white; font-size: 22px;text-align: left;">Future</th>
				</tr>
				<!--<tr id='head' name='custom-apis'>
					<th>S.No.</th>
					<th>Date</th>
