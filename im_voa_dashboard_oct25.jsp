...
function compare_report()
{
	...
	document.entryfrm.action="im_voa_dashboard_oct25.jsp?icp="+document.entryfrm.compare_icp.value;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div class="col-sm-7">
<div class="card"style="border: solid 3px #007d79; border-radius: 20px; height:600px; width:1200px;">
...
<canvas id="canvasPAX_Total" class="chart" style="max-width: 100%;background: linear-gradient(to bottom, #ffffff 20%, #cdf7f7 100%);border-radius: 20px;height:600px; width:1200px;"></canvas>
...
<div class="col-sm-8">
<div class="card"style="border: solid 3px #7d70bc; border-radius: 20px; height:600px; width:1100px;">
<div class="card-body" style="height:600px;width:1100px;">
	<!--<h1 style="font-size: 20px; color: #666666;font-weight: bold; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif; background-color: #ffffff">All ICPs Arrival and Departure e-Passport Statistics</h1>-->
<canvas id="canvasCountry_ArrivalYear" class="chart" style="max-width: 100%;background: linear-gradient(to bottom, #ffffff 20%, #e7e5f3 100%);border-radius: 20px;height:600px; width:1100px;"></canvas>
...
var myData_totalarr = {
	...
	{ 
		...
		var myoptionsarr = {
			...
			duration: 1,
			onComplete: function () {
				var chartInstancesarr = this.chart,
					ctx = chartInstancesarr.ctx;
					ctx.textAlign = 'center';
					...
					this.data.datasets.forEach(function (dataset, i) {
						var metas = chartInstancesarr.controller.getDatasetMeta(i);
						metas.data.forEach(function (bar, index) {
							var dataarr = dataset.data[index];
							ctx.fillText(dataarr, bar._model.x+22, bar._model.y+5);
