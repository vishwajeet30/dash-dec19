			...
			<div class="container"> 
			  ...
			  <div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav">
				  ...
				  <li> <a class="scrollLink dropdown-item" href="#ICS_Nationality">Indian/Foreigner Based Statistics in last 7 days</a></li>
				  ...
				  <li> <a class="scrollLink dropdown-item" href="#Future">Future Data</a></ul></li>
...
%>
	...
	<table class="tableDesign">
		<!--<caption style="font-size: 22px; color: grey; line-height: 50px; text-align: center; padding-top: 5px;font-weight: bold; font-family: 'Arial', serif;">Arrival Clearance in last 7 hours</caption>-->
				...
				<tr style="font-size: 15px;  text-align: right; color:white; border-color: #003a6d;">
					<th style=" width:25%; background-color:#6929c4;border-color: #491d8b;width:12.5%; text-align: center;">S.No.</th>
	...
	while (rsTemp.next()) {	
		...
		<tr style="font-size: 12px; font-family: 'Arial', serif; height:20px;">
			<td style="background-color:#9460de; width:25%; border-color: #491d8b;width:12.5%; font-weight: bold; text-align: center;"><%=++counter%></td>
...
<!--*******************-->
	<%//////////////////////	Doughnut - Agewise Statistics in last 7 days - Start	/////////////////////////////////

	String WeeklyArrAgewisePT = "";
	String WeeklyArrAgewiseXAxisPT = "";
	int M0_M6_ArrPT = 0;
	int M6_Y1_ArrPT = 0;
	int Y1_Y5_ArrPT = 0;
	int Y5_Y10_ArrPT = 0;
	...
	int Y70_Y80_ArrPT = 0;
	int Y80_Y90_ArrPT = 0;
	int Y90_Y100_ArrPT = 0;
	int Y100_ArrPT = 0;
	

	StringBuilder weekDaysAgewisePT = new StringBuilder();
	StringBuilder weekM0_M6_ArrPT = new StringBuilder();
	StringBuilder weekM6_Y1_ArrPT = new StringBuilder();
	StringBuilder weekY1_Y5_ArrPT = new StringBuilder();
	StringBuilder weekY5_Y10_ArrPT = new StringBuilder();
	StringBuilder weekY10_Y20_ArrPT = new StringBuilder();
	StringBuilder weekY20_Y30_ArrPT = new StringBuilder();
	StringBuilder weekY30_Y40_ArrPT = new StringBuilder();
	StringBuilder weekY40_Y50_ArrPT = new StringBuilder();
	StringBuilder weekY50_Y60_ArrPT = new StringBuilder();
	StringBuilder weekY60_Y70_ArrPT = new StringBuilder();
	StringBuilder weekY70_Y80_ArrPT = new StringBuilder();
	StringBuilder weekY80_Y90_ArrPT = new StringBuilder();
	StringBuilder weekY90_Y100_ArrPT = new StringBuilder();
	StringBuilder weekY100_ArrPT = new StringBuilder();

	 flagFlightCountb = false;
	try {
		WeeklyArrAgewisePT = "select  SUM(M0_M6) as M0_M6, SUM(M6_Y1) as M6_Y1,SUM(Y1_Y5) as Y1_Y5,SUM(Y5_Y10) as Y5_Y10,SUM(Y10_Y20) as Y10_Y20,SUM(Y20_Y30) as Y20_Y30,SUM(Y30_Y40) as Y30_Y40,SUM(Y40_Y50) as Y40_Y50,SUM(Y50_Y60) as Y50_Y60,SUM(Y60_Y70) as Y60_Y70,SUM(Y70_Y80) as Y70_Y80,  SUM(Y80_Y90) as Y80_Y90,  SUM(Y90_Y100) as Y90_Y100,  SUM(Y100) as Y100,  icp_description,to_char(pax_boarding_date,'Mon-dd') as pax_boarding_date_2, pax_boarding_date,ICP_SRNO, table_type from im_dashboard_combined where ICP_SRNO = '"+ filter_icp +"' and  pax_boarding_date = trunc(sysdate)  and table_type='IM_TRANS_DEP_TOTAL' group by pax_boarding_date,table_type,icp_description,ICP_SRNO  order by pax_boarding_date";

		psTemp = con.prepareStatement(WeeklyArrAgewisePT);
		rsTemp = psTemp.executeQuery();
		while (rsTemp.next()) {

			WeeklyArrAgewiseXAxisPT = rsTemp.getString("pax_boarding_date_2");
			//out.println(weeklyVisaXAxis);
			M0_M6_ArrPT = rsTemp.getInt("M0_M6");
			M6_Y1_ArrPT = rsTemp.getInt("M6_Y1");
			Y1_Y5_ArrPT = rsTemp.getInt("Y1_Y5");
			Y5_Y10_ArrPT = rsTemp.getInt("Y5_Y10");
			Y10_Y20_ArrPT = rsTemp.getInt("Y10_Y20");
			Y20_Y30_ArrPT = rsTemp.getInt("Y20_Y30");
			Y30_Y40_ArrPT = rsTemp.getInt("Y30_Y40");
			Y40_Y50_ArrPT = rsTemp.getInt("Y40_Y50");
			Y50_Y60_ArrPT = rsTemp.getInt("Y50_Y60");
			Y60_Y70_ArrPT = rsTemp.getInt("Y60_Y70");
			Y70_Y80_ArrPT = rsTemp.getInt("Y70_Y80");
			Y80_Y90_ArrPT = rsTemp.getInt("Y80_Y90");
			Y90_Y100_ArrPT = rsTemp.getInt("Y90_Y100");
			Y100_ArrPT = rsTemp.getInt("Y100");
			//out.println(weeklyOCICount);

			if (flagFlightCountb == true) {
			  weekDaysAgewisePT.append(",");
			  weekM0_M6_ArrPT.append(",");
			  weekM6_Y1_ArrPT.append(",");
			  weekY1_Y5_ArrPT.append(",");
			  weekY5_Y10_ArrPT.append(",");
			  weekY10_Y20_ArrPT.append(",");
			  weekY20_Y30_ArrPT.append(",");
			  weekY30_Y40_ArrPT.append(",");
			  weekY40_Y50_ArrPT.append(",");
			  weekY50_Y60_ArrPT.append(",");
			  weekY60_Y70_ArrPT.append(",");
			  weekY70_Y80_ArrPT.append(",");
			  weekY80_Y90_ArrPT.append(",");
			  weekY90_Y100_ArrPT.append(",");
			  weekY100_ArrPT.append(",");
			...
			weekDaysAgewisePT.append("\"");
			weekDaysAgewisePT.append(WeeklyArrAgewiseXAxisPT);
			weekDaysAgewisePT.append("\"");
			
			weekM0_M6_ArrPT.append(M0_M6_ArrPT);
			weekM6_Y1_ArrPT.append(M6_Y1_ArrPT);
			weekY1_Y5_ArrPT.append(Y1_Y5_ArrPT);
			  weekY5_Y10_ArrPT.append(Y5_Y10_ArrPT);
			  weekY10_Y20_ArrPT.append(Y10_Y20_ArrPT);
			  weekY20_Y30_ArrPT.append(Y20_Y30_ArrPT);
			  weekY30_Y40_ArrPT.append(Y30_Y40_ArrPT);
			  weekY40_Y50_ArrPT.append(Y40_Y50_ArrPT);
			  weekY50_Y60_ArrPT.append(Y50_Y60_ArrPT);
			  weekY60_Y70_ArrPT.append(Y60_Y70_ArrPT);
			  weekY70_Y80_ArrPT.append(Y70_Y80_ArrPT);
			  weekY80_Y90_ArrPT.append(Y80_Y90_ArrPT);
			  weekY90_Y100_ArrPT.append(Y90_Y100_ArrPT);
			  weekY100_ArrPT.append(Y100_ArrPT);
	...
	String strWeekDaysAgewisePT = weekDaysAgewisePT.toString();
	String strweekM0_M6_ArrPT = weekM0_M6_ArrPT.toString();
	String strweekM6_Y1_ArrPT = weekM6_Y1_ArrPT.toString();
	String strweekY1_Y5_ArrPT = weekY1_Y5_ArrPT.toString();
	String strweekY5_Y10_ArrPT = weekY5_Y10_ArrPT.toString();
	String  strweekY10_Y20_ArrPT = weekY10_Y20_ArrPT.toString();
	String  strweekY20_Y30_ArrPT = weekY20_Y30_ArrPT.toString();
	 String strweekY30_Y40_ArrPT = weekY30_Y40_ArrPT.toString();
	 String strweekY40_Y50_ArrPT = weekY40_Y50_ArrPT.toString();
	String  strweekY50_Y60_ArrPT = weekY50_Y60_ArrPT.toString();
	 String strweekY60_Y70_ArrPT = weekY60_Y70_ArrPT.toString();
	 String strweekY70_Y80_ArrPT = weekY70_Y80_ArrPT.toString();
	 String strweekY80_Y90_ArrPT = weekY80_Y90_ArrPT.toString();
	 String strweekY90_Y100_ArrPT = weekY90_Y100_ArrPT.toString();
	 String strweekY100_ArrPT = weekY100_ArrPT.toString();
...
<div class="card-body">
<h1 style="font-size: 20px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Age Wise Statistics Today</h1>
<hr>
<canvas id="canvasAgeHalf" class="chart"  style="background: linear-gradient(to bottom, #ffffff 0%, #f79bbe 100%);border-radius: 20px;"></canvas>
</div>
</div>   
</div>
</div>   
...
<script src="js/chartjs-plugin-datalabels.min.js"></script>
    ...
    Chart.register(ChartDataLabels);
		...
		var myDataD = {
				labels: ['6 Months', '6 Months to 1 Year','M','N','O','P','Q','R','S','T','U','V','W','X','Y'],
				  datasets: [{
				    data: [<%=strweekM0_M6_ArrPT%>,<%=strweekM6_Y1_ArrPT%>,<%=strweekY1_Y5_ArrPT%>,<%=strweekY5_Y10_ArrPT%>,<%=strweekY10_Y20_ArrPT%>,<%=strweekY20_Y30_ArrPT%>,<%=strweekY30_Y40_ArrPT%>,<%=strweekY40_Y50_ArrPT%>,<%=strweekY50_Y60_ArrPT%>,<%=strweekY60_Y70_ArrPT%>,<%=strweekY70_Y80_ArrPT%>,<%=strweekY80_Y90_ArrPT%>,<%=strweekY90_Y100_ArrPT%>,<%=strweekY100_ArrPT%>],
				    backgroundColor: [
				      '#EA1179',
				      '#B5EAEA',
				      '#0802A3',
		...
		var ctx = document.getElementById('canvasAgeHalf').getContext('2d');
...
<!--   ************************START Custom APIS DIV*******************START Custom APIS DIV*****************START Custom APIS DIV****************START UCF DIV********  -->
		...
		<table id = "auto-index5" class="table table-sm table-striped">
			<thead>
			<tr id='head1'>
					<th style="font-family: Arial;background-color: #1192e8; color: white; font-size: 22px;text-align: left;">Flight-Wise Pax Data (Last 10 hours and Upcoming 10 Hours)</th>
				</tr>
				<!--<tr id='head' name='custom-apis'>
					<th>S.No.</th>
					<th>Date</th>
											...
											<td style="vertical-align:bottom">
												<table  style="padding:1px 1px;border-collapse: collapse;background-color:#FFFFFF;font-family:verdana;font-size:10pt;" align="center" bordercolorlight="#FF99CC" bordercolordark="#FF99CC" bordercolor="#FF99CC" border=0;  width="100%" cellpadding="0" cellspacing="0" >
													...
													%>	
														...
														%>
															<!--<tr>
																<td style="font-weight: bold;text-align: center;" colspan="2"><%=current_hour_pax_sum%></td>
															</tr>-->
														<%
