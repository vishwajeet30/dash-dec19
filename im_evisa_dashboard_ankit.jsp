				...
				<td>
					<div class="col-sm-2">
						...
						<tr style="font-size: 15px;  text-align: right; color:white; border-color: #3B7DD8;height:12px;background-color:#ed459d;">
							...
							<th style="background-color:#ed459d;border-color: #f6a2ce; text-align: right;width:22%;">Arrival&nbsp;e&#8209;Visa&nbsp;</th>
						</tr>
<% 
					}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div class="col-sm-5">
	<div class="card"style="border: solid 3px #e81784; border-radius: 20px;width:1500px;">
	<div class="card-body" style="height:1100px; width:1500px;">		
	...
	<canvas id="canvasPAX_icp" class="chart" style="max-width: 100%;border-radius: 20px;background: linear-gradient(to bottom, #ffffff 50%, #ffe9f1 100%);width:1200px;"></canvas><br>
</div>
	</div>
	</div>
	</div>
			...
			onComplete: function () {
				var chartInstances = this.chart,
					...
					this.data.datasets.forEach(function (dataset, i) {
						...
						metas.data.forEach(function (bar, index) {
							var data = dataset.data[index];
							ctx.fillText(data, bar._model.x+27, bar._model.y+6);
	...
	while (rsTemp.next()) {
		...
		////////////////////////////////////////
			...
			<tr style="font-size: 15px;   color:white; border-color: #3B7DD8;height:12px;border-radius: 20px;">
				...
				<th style="background-color:#6D5EB4;border-color: #efedf6; text-align: left;width:15%;">Country</th>
				<th style="background-color:#6D5EB4;border-color: #efedf6; text-align: right;width:25%;">Arrival&nbsp;e&#8209;Visa&nbsp;</th>
			</tr>
			<%
			}
...
<div class="container-fluid">
	...
	<div class="card" style="border: solid 3px #776ab9; border-radius: 20px; height:550px;width:1450px;">
	<div class="card-body" style="height:550px; width:1450px;">
