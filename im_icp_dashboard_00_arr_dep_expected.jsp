...
function letternumber(e, str)
		...
		{
				document.entryfrm.target="_self";
				document.entryfrm.action="im_icp_dashboard.jsp?&icp="+document.entryfrm.compare_icp.value+"&default_hrs="+document.entryfrm.default_hrs.value;
...
try
  {
%>
<form action="im_icp_dashboard_00.jsp#Arr_Sch_Flts" method="post" >

<div class="fixTableHead">
<input type="hidden" name="filter_date" value="<%=vDate.format(current_Server_Time)%>"/>
<input type="hidden" name="icp" value="<%=filter_icp%>">
<table class="tableDesign">
	...
	<tr style="background-color:#a56eff;font-weight:bold;font-size: 12px;height: 30px;">
		...
		<th style="text-align:right;background-color:#a56eff; border-color: #a56eff; color: white; font-weight:normal;" colspan="5">Current Server Time : <%=vFileName%></th>
			...
			<tr style="background-color:#be95ff;font-weight:bold; color: white;font-size: 14px;height: 25px;border-top-right-radius: 0px;">
