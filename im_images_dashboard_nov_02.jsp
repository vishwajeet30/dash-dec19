...
function compare_report()
{
	...
	document.entryfrm.action="im_images_dashboard_nov_02.jsp?icp="+document.entryfrm.compare_icp.value;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div class="col-sm-6">
<div class="card"style="border: solid 3px #007d79; border-radius: 20px;  width:925px" >
<div class="card-body" style="height:1700px; width:925px;">
	...
	<canvas id="canvasAll_Icp" class="chart" style="max-width: 100%;background: linear-gradient(to bottom, #ffffff 20%, #cdf7f7 100%);border-radius: 20px;height:1700px; width:925px;"></canvas>
</div>
</div>
</div>
</div>
...
<div class="col-sm-6">
<div class="card"style="border: solid 3px #007d79; border-radius: 20px; height:900px; width:1025px" >
<div class="card-body" style="height:900px; width:1025px;">
	<!--<h1 style="font-size: 20px; color: #666666;font-weight: bold; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif; background-color: #ffffff">All ICPs Arrival and Departure e-Passport Statistics</h1>-->
<canvas id="canvasAll_Icp_daywise" class="chart" style="max-width: 100%;background: linear-gradient(to bottom, #ffffff 20%, #cdf7f7 100%);border-radius: 20px;height:900px;width:1025px;"></canvas>
</div>
</div>
</div>
 <script>
	...
	<div class="col">
		...
		<thead>
			...
			<tr style="font-size: 16px;  text-align: right; color:white; border-color: #009688;height:12px; ">
				<th style="text-align: center;background-color:#007d79;border-color: #005555;width:16.66%;">Year</th>
...
try
	...
	while (rsTemp.next()){
		...
		/*	if(rsTemp.getInt("arr_year") < 2005 ) 
		{
			...
			<tr style="font-size: 14px; font-family: 'Arial', serif; border-color: #6929c4;height:18px;">
				<td style="background-color:#d9fbfb;border-color:#005555;width:16.66%; font-weight: bold;text-align: center;"><%=monthValue.get(rsTemp.getString("month_date").substring(4,6)) + "-" +rsTemp.getString("month_date").substring(0,4)%></td>
				<td style="background-color:#d9fbfb;border-color:#005555;width:16.66%; font-weight: bold; text-align: right;"><%=rsTemp.getInt("camera_count") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("camera_count"))%>&nbsp;</td>
				<td style="background-color:#d9fbfb;border-color:#005555;width:16.66%; font-weight: bold; text-align: right;"><%=rsTemp.getInt("passport_count") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("passport_count"))%>&nbsp;</td>
				<td style="background-color:#d9fbfb;border-color:#005555;width:16.66%; font-weight: bold; text-align: right;"><%=rsTemp.getInt("decard_count") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("decard_count"))%>&nbsp;</td>
				<td style="background-color:#d9fbfb;border-color:#005555;width:16.66%; font-weight: bold; text-align: right;"><%=rsTemp.getInt("visa_count") == 0 ? "&nbsp;": getIndianFormat(rsTemp.getInt("visa_count"))%>&nbsp;</td>
				<td style="background-color:#d9fbfb;border-color:#005555;width:16.66%; font-weight: bold; text-align: right;color: #005653;font-size:15px;"><%=getIndianFormat((rsTemp.getInt("camera_count") + rsTemp.getInt("passport_count") + rsTemp.getInt("decard_count") + rsTemp.getInt("visa_count")))%>&nbsp;</td>
			</tr>
<%
...
%>			<tr style="font-size: 16px;  text-align: right; color:#005653; border-color: #009688;height:12px;">
				<td style="background-color:#8ee8f2;border-color:#005555;width:33.33%; font-weight: bold;text-align: center;">Total</td>
				<td style="background-color:#8ee8f2;border-color:#005555;width:33.33%; font-weight: bold; text-align: right;"><%=getIndianFormat(all_ICP_Camera_Total_monthwise)%>&nbsp;</td>
				<td style="background-color:#8ee8f2;border-color:#005555;width:33.33%; font-weight: bold; text-align: right;"><%=getIndianFormat(all_ICP_Passport_Total_monthwise)%>&nbsp;</td>
				<td style="background-color:#8ee8f2;border-color:#005555;width:33.33%; font-weight: bold; text-align: right;"><%=getIndianFormat(all_ICP_DECard_Total_monthwise)%>&nbsp;</td>
				<td style="background-color:#8ee8f2;border-color:#005555;width:33.33%; font-weight: bold; text-align: right;"><%=getIndianFormat(all_ICP_Visa_Total_monthwise)%>&nbsp;</td>
				<td style="background-color:#8ee8f2;border-color:#005555;width:33.33%; font-weight: bold; text-align: right;font-size:15px;"><%=getIndianFormat(all_ICP_Total_monthwise)%>&nbsp;</td>
			</tr>
			<%
			rsTemp.close();
			psTemp.close();
				...
				<td>
					<div class="col-sm-4" style="width:750px;">
						...
						<tr style="font-size: 15px;  text-align: right; color:white; border-color: #3B7DD8;height:12px;background-color:#ed459d;">
							...
							<th style="background-color:#ed459d;border-color: #f6a2ce; text-align: right;width:22%;">Camera&nbsp;</th>
							<th style="background-color:#ed459d;border-color: #f6a2ce; text-align: right;width:23%;">Passport&nbsp;</th>
							<th style="background-color:#ed459d;border-color: #f6a2ce; text-align: right;width:23%;">D/E&nbsp;Card&nbsp;</th>
							<th style="background-color:#ed459d;border-color: #f6a2ce; text-align: right;width:23%;">Visa&nbsp;</th>
...
%>						<tr style="font-size: 15px;  text-align: right; color:white; border-color: #3B7DD8;height:12px;background-color:#ed459d;">
						...
						<td style="background-color:#ed459d;border-color:#f6a2ce; font-weight: bold; text-align: right;width:22%;"><%=getIndianFormat(img_Camera_Total)%>&nbsp;</td>
						<td style="background-color:#ed459d;border-color:#f6a2ce; font-weight: bold; text-align: right;width:23%;"><%=getIndianFormat(img_Passport_Total)%>&nbsp;</td>
						<td style="background-color:#ed459d;border-color:#f6a2ce; font-weight: bold; text-align: right;width:23%;"><%=getIndianFormat(img_DECard_Total)%>&nbsp;</td>
						<td style="background-color:#ed459d;border-color:#f6a2ce; font-weight: bold; text-align: right;width:23%;"><%=getIndianFormat(img_Visa_Total)%>&nbsp;</td>
						<td style="background-color:#ed459d;border-color:#f6a2ce; font-weight: bold; text-align: right;color:white;font-size: 15px;width:25%;"><%=getIndianFormat(img_Total)%>&nbsp;</td>
					</tr>
<%					} 
					else 
					{ 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div class="col-sm-6">
	<div class="card"style="border: solid 3px #e81784; border-radius: 20px;width:1400px;">
	<div class="card-body" style="height:2000px; width:1400px;">		
