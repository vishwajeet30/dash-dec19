 ...
 -->			</tr>
		<% 
			...
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center;height:20px;">
				...
				<td style="background-color:#f7ac99;border-color: #ed3e12;width:20%; font-weight: bold; text-align: right;"><%=RegularWeekly[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(RegularWeekly[i]))%>&nbsp;&nbsp;</td>
				<td style="background-color:#f9bfb0;border-color: #ed3e12;width:20%; font-weight: bold; text-align: right;"><%=eVisaWeekly[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(eVisaWeekly[i]))%>&nbsp;&nbsp;</td>
				<td style="background-color:#fbd1c7;border-color: #ed3e12;width:20%; font-weight: bold; text-align: right;"><%=OCIWeekly[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(OCIWeekly[i]))%>&nbsp;&nbsp;</td>
...
<div class="col-sm-8">
<div class="card" style="border: solid 3px #FF5733; border-radius: 20px; height:470px;">
<div class="card-body" style="height:470px;">
<canvas id="canvasWeeklyVisa" class="chart" style="max-width: 100%; background: linear-gradient(to bottom, #ffffff 35%, #fbc7dc 100%);border-radius: 20px; height:470px;"></canvas>
</div>
</div>
</div>
</div>
