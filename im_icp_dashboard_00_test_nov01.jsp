...
//=================================================
//IM_DASHBOARD_COMBINED_PAX_BOARDING_DATE
	Connection con = null;
try {
...
<table class="tableDesign">
	...
	<%///////////////////////	Table -  Arrival and Departure TABS - End	////////////////////////%>
	...
	<div class="col-sm-2">
		...
		<table class="tableDesign">
			...
			<tr style="font-size: 16px;  text-align: right; color:white; border-color: #6929c4;height:20px;">
					<th style="text-align: center;background-color:#6929c4;border-color: #401977;width:33.33%;">&nbsp;</th>
					<th colspan = "3" style="text-align: center;background-color:#6929c4;border-color: #401977;width:66.66%; text-align: center;">Total Footfall</th>
				</tr>
			<tr style="font-size: 16px;  text-align: right; color:white; border-color: #6929c4;height:20px; ">
				<th style="background-color:#7a3ad6;border-color: #6929c4;width:25%;text-align: center;">Date</th>
				<th style="background-color:#7a3ad6;border-color: #6929c4;width:33.33%; text-align: right;">Arr&nbsp;</th>
				<th style="background-color:#7a3ad6;border-color: #6929c4;width:33.33%; text-align: right;">Dep&nbsp;</th>
				<th style="background-color:#7a3ad6;border-color: #6929c4;width:33.33%; text-align: right;">Total&nbsp;</th>
			</tr>
		<% 
			...
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
				...
				<td style="background-color:#d4bbff;border-color: #6929c4;width:33.33%; font-weight: bold; text-align: right;"><%=weeklyArrPAX[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(weeklyArrPAX[i]))%>&nbsp;</td>
				<td style="background-color:#e8daff;border-color: #6929c4;width:33.33%; font-weight: bold; text-align: right;"><%=weeklyDepPAX[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(weeklyDepPAX[i]))%>&nbsp;</td>
				<td style="background-color:#e8daff;border-color: #6929c4;width:33.33%; font-weight: bold; text-align: right;color:#6929c4;"><%=t_Total == 0 ? "&nbsp;" : getIndianFormat(t_Total)%>&nbsp;</td>
			</tr>
<%
			}
			%>
...
<div class="col">
<div class="card" style="border: solid 3px #7a3ad6; border-radius: 20px; height:300px;width:500px;">
<div class="card-body"style="height:300px;width:500px;">

<canvas id="canvasPAX" class="chart" style="max-width: 100%; background: linear-gradient(to bottom, #ffffff 35%, #b1d2d8 100%); border-radius:20px; height:300px;width:500px;"></canvas>
</div>
</div>
</div>
<script>
...
<div class="col-sm-2">
		<table class="tableDesign">
			...
			<tr style="font-size: 16px; font-family: 'Arial', serif;color: white; font-weight: bold; text-align: center;border-color: #ed3e12;height:20px;">
				<th style="background-color:#ef5731;border-color: #ed3e12;width:25%;">Date</th>
				<th style="background-color:#ef5731;border-color: #ed3e12;width:25%; text-align: right;">Arr&nbsp;</th>
				<th style="background-color:#ef5731;border-color: #ed3e12;width:25%; text-align: right;">Dep&nbsp;</th>
				<th style="background-color:#ef5731;border-color: #ed3e12;width:25%; text-align: right;">Total&nbsp;</th>
			</tr>
		<% 
		...
		%>
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center;height:18px;border-color: #ed3e12">
				...
				<td style="background-color:#f8b8a9;border-color: #ed3e12;width:25%;font-weight: bold;  text-align: right;"><%=weeklyArrFlights[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(weeklyArrFlights[i]))%>&nbsp;</td>
				<td style="background-color:#fcddd5;border-color: #ed3e12;width:25%; font-weight: bold; text-align: right;"><%=weeklyDepFlights[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(weeklyDepFlights[i]))%>&nbsp;</td>
				<td style="background-color:#fcddd5;border-color: #ed3e12;width:25%; font-weight: bold; text-align: right;color:#ed3e12;"><%=t_Total == 0 ? "&nbsp;" : getIndianFormat(t_Total)%>&nbsp;</td>
			</tr>
<%
			}
			%>
...
<div class="card-body" style="height:300px;">
	<!--	<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif; background-color: #ffffff">Arrival
		...
		<canvas id="canvasFlights" style="max-width: 100%;background: linear-gradient(to bottom, #ffffff 35%, #faaca8 100%);border-radius: 20px; height:300px;"></canvas>
...
<%/////////<div class="parallax1">//////////////////////	Arrival and Departure Flights in last 7 days - End	/////////////////////////////////////////%>
...
<div class="row">
	...
	<table class="tableDesign">
		<!--<caption style="font-size: 22px; color: grey; line-height: 50px; text-align: center; padding-top: 5px;font-weight: bold; font-family: 'Arial', serif;">Arrival Clearance in last 7 hours</caption>-->
				<tr style="font-size: 18px;  text-align: right; color:white; border-color: #003a6d;height:50px;">
				...
				<tr style="font-size: 14px;  text-align: right; color:white; border-color: #003a6d;height:40px;">
					...
					<th style="text-align: center; width:25%; background-color:#ca3669;border-color: #91264b;width:25%; text-align: center;">Active<br>Flights</th>
					<th style="text-align: center; width:25%; background-color:#ca3669;border-color: #91264b;width:25%; text-align: center;">Active<br>Counters</th>
				</tr>
		<% 
			...
			<tr style="font-size: 14px; font-family: 'Arial', serif; height:20px;">
				<td style="background-color:#dc799b; width:25%; border-color: #91264b;width:25%; font-weight: bold; text-align: center;"><%=weekList[i].equals("0") ? "&nbsp;" : weekList[i].replace(" ","&nbsp;")%></td>
				<td style="background-color:#e497b2; width:25%; border-color: #91264b;width:25%; font-weight: bold; text-align: right;"><%=arrPax[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(arrPax[i]))%>&nbsp;&nbsp;&nbsp;</td>
				<td style="background-color:#ecb6c8; width:25%; border-color: #91264b;width:25%; font-weight: bold; text-align: right;"><%=arrFlight[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(arrFlight[i]))%>&nbsp;&nbsp;&nbsp;</td>
				<td style="background-color:#f4d7e1; width:25%; border-color: #91264b;width:25%; font-weight: bold; text-align: right;"><%=arrCounter[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(arrCounter[i]))%>&nbsp;&nbsp;&nbsp;</td>
			</tr>
<%
			}
			%>
...
<div class="col-sm-3">
<div class="card" style="border: solid 3px #B93160; border-radius: 20px; height:400px;width:500px;">
<div class="card-body" style=" height:400px;width:500px;">
<!-- <h1 style="font-size: 12px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif; background-color: #ffffff">Arrival : PAX Clearance, Active Flights and Active Counters in last <%=displayHours%> hours</h1> -->

		<canvas id="canvasArrPAXFltActCount" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #e5a4ba 100%); border-radius: 20px;height:400px;width:500px;"></canvas>
	</div>
	</div>
	</div>
		...
		<table class="tableDesign">
			...
			<!-- #005d5d -->
				...
				<tr style="font-size: 14px; font-family: 'Arial', serif;color: white; font-weight: bold; text-align: center;border-color: #1192e8;height:40px;">
					...
					<th style="text-align: center;background-color:#009494;border-color: #005b5b;width:25%; font-weight: bold; text-align: center;">Active<br>Flights</th>
					<th style="text-align: center;background-color:#009494;border-color: #005b5b;width:25%; font-weight: bold; text-align: center;">Active<br>Counters</th>
				</tr>
			<%
			//strHourlyTime = hourlyDepTime.toString();
			//String strHourlyDepPax = hourlyDepPax.toString();
			...
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center;height:20px;">
				<td style="background-color:#08c4c1;border-color: #005d5d;width:25%; font-weight: bold;text-align: center;"><%=depWeekList[i].equals("0") ? "&nbsp;" : depWeekList[i].replace(" ","&nbsp;")%></td>
				<td style="background-color:#3ddbd9;border-color: #005d5d;width:25%; font-weight: bold; text-align: right;"><%=depPax[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(depPax[i]))%>&nbsp;&nbsp;</td>
				<td style="background-color:#9ef0f0;border-color: #005d5d;width:25%; font-weight: bold; text-align: right;"><%=depFlight[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(depFlight[i]))%>&nbsp;&nbsp;</td>
				<td style="background-color:#d9fbfb;border-color: #005d5d;width:25%; font-weight: bold; text-align: right;"><%=depCounter[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(depCounter[i]))%>&nbsp;&nbsp;</td>
			</tr>
...
<div class="col-sm-3">
	<div class="card" style="border: solid 3px #006778; border-radius: 20px;height:400px;width:500px;">
	<div class="card-body" style=" height:400px;width:500px;">
		...
		<canvas id="canvasDepPAXFltActCount" class="chart" style="max-width: 100%;      background: linear-gradient(to bottom, #ffffff 35%, #75ebff 100%);border-radius: 20px;height:400px;width:500px;"></canvas>
	</div>
</div>
</div>
</div>
	...
	<div class="col-sm-2">
		...
		<% 
			...
			<tr style="font-size: 16px; font-family: 'Arial', serif; text-align: center;height:20px;">
				...
				<td style="background-color:#b7f5ff;border-color: #006778;width:50%; font-weight: bold; text-align: right;"><%=hourListDepFltCount[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(hourListDepFltCount[i]))%>&nbsp;&nbsp;</td>
...
<div class="container-fluid">
	...
	<table class="tableDesign">
		...
		<% 
			...
			%>
			<tr style="font-size: 16px; font-family: 'Arial', serif; text-align: center;height:20px;">
				<td style="background-color:#f27555;border-color: #ed3e12;width:20%; font-weight: bold;text-align: center;"><%=weekListWeekly[i].equals("0") ? "&nbsp;" : weekListWeekly[i]%></td>
				<td style="background-color:#f4896f;border-color: #ed3e12;width:20%; font-weight: bold; text-align: right;"><%=eVisaWeekly[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(eVisaWeekly[i]))%>&nbsp;&nbsp;</td>
				<td style="background-color:#f69e89;border-color: #ed3e12;width:20%; font-weight: bold; text-align: right;"><%=OCIWeekly[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(OCIWeekly[i]))%>&nbsp;&nbsp;</td>
				<td style="background-color:#f8b7a7;border-color: #ed3e12;width:20%; font-weight: bold; text-align: right;"><%=RegularWeekly[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(RegularWeekly[i]))%>&nbsp;&nbsp;</td>
				<td style="background-color:#fac9bd;border-color: #ed3e12;width:20%; font-weight: bold; text-align: right;"><%=VOAWeekly[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(VOAWeekly[i]))%>&nbsp;&nbsp;</td>
				<td style="background-color:#fcddd5;border-color: #ed3e12;width:20%; font-weight: bold; text-align: right;"><%=ExWeekly[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(ExWeekly[i]))%>&nbsp;&nbsp;</td>
			</tr>
<%
			}
			%>
...
*/
			%>
			<tr style="font-size: 16px; font-family: 'Arial', serif; text-align: center;height:20px;">
				<td style="background-color:#f27555;border-color: #ed3e12;width:20%; font-weight: bold;text-align: center;"><%=WeekListVisaHourly[i].equals("0") ? "&nbsp;" : WeekListVisaHourly[i]%></td>
				<td style="background-color:#f4896f;border-color: #ed3e12;width:20%; font-weight: bold; text-align: right;"><%=eVisa[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(eVisa[i]))%>&nbsp;&nbsp;</td>
				<td style="background-color:#f69e89;border-color: #ed3e12;width:20%; font-weight: bold; text-align: right;"><%=OCIVisaHourly[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(OCIVisaHourly[i]))%>&nbsp;&nbsp;</td>
				<td style="background-color:#f8b7a7;border-color: #ed3e12;width:20%; font-weight: bold; text-align: right;"><%=RegularVisaHourly[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(RegularVisaHourly[i]))%>&nbsp;&nbsp;</td>
				<td style="background-color:#fcddd5;border-color: #ed3e12;width:20%; font-weight: bold; text-align: right;"><%=VOAVisaHourly[i].equals("0") ? "&nbsp;" : getIndianFormat(Integer.parseInt(VOAVisaHourly[i]))%>&nbsp;&nbsp;</td>
			</tr>
...
<div class="col-sm-3">
<div class="card" style="border: solid 3px #007d79; border-radius: 20px;height:400px; width:400px;">
...
<!-- <h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	...
	<canvas id="canvasWeeklyBio_Arr" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #9ef0f0 100%); border-radius: 20px;height:400px; width:400px;"></canvas>
	</div>
	</div>	
	</div>
...
&nbsp;&nbsp;&nbsp;
	<div class="col-sm-2">
		<table class="tableDesign" >
			<!--<caption style="font-size: 22px; color: grey; line-height: 50px; text-align: center; padding-top: 5px;font-weight: bold; font-family: 'Arial', serif;">Arrival and Departure Immigration Clearance in last 7 days</caption>-->
			<tr style="font-size: 16px; font-family: 'Arial', serif;color: white; font-weight: bold; text-align: center;border-color: #1192e8;height:40px;">
				<th style="width:40%;text-align: center;background-color:#e93d6b;border-color: #c41645; text-align: center;">Date</th>
...
<div class="col-sm-3">
<div class="card" style="border: solid 3px #da1e28; border-radius: 20px;height:400px; width:400px;">
<div class="card-body" style="height:400px; width:400px;">
<!-- <h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Biometric Enrollment/Verification/Exemption in last <%=displayHours%> hours</h1> -->

	<canvas id="canvasWeeklyBio_Arrh" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #f79bbe 100%); border-radius: 20px;height:400px; width:400px;"></canvas>
	</div>
	</div>	
	</div>
	</div>
...
&nbsp;
<div class="col-sm-3">
<div class="card" style="border: solid 3px #c51748; border-radius: 20px; height:400px; width:450px;">
...
<!--<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Arrival : Gender Based Statistics in last 7 days</h1>-->
		...
		<canvas id="canvasWeeklyGender_Arrweek" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #faceda 100%);border-radius: 20px; height:400px;width:450px;"></canvas>
	</div>
	</div>	
	</div>
...
&nbsp;&nbsp;
<div class="col-sm-3">
<div class="card" style="border: solid 3px #014F86; border-radius: 20px; height:400px; width:450px;">
<div class="card-body" style=" height:400px;width:450px;">
<!--<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Departure : Gender Based Statistics in last 7 days</h1>-->

		<canvas id="canvasWeeklyGender_Depweek" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #bae6ff 100%);border-radius: 20px;height:400px;width:450px;"></canvas>
	</div>
	</div>	
	</div>
	</div>
	...
	<div class="col-sm-2">
		<table class="tableDesign" >
			...
			<tr style="font-size: 15px;  text-align: right; color:white; border-color: #009688;height:12px;">
				<th style="text-align: center;background-color:#00ada7;border-color: #007d79;width:33.33%;">Year</th>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div class="col-sm-3">
<div class="card" style="border: solid 3px #007d79; border-radius: 20px; height:400px; width:450px;">
<div class="card-body" style=" height:400px; width:450px;">
<!-- <h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Arrival : Indian/Foreigner Statistics in last 7 days</h1> -->

	<canvas id="canvasWeeklyNationality_Arr" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #9ef0f0 100%); border-radius: 20px; height:400px; width:450px;"></canvas>
	</div>
	</div>	
	</div>
	...
	<div class="col-sm-2">
		<table class="tableDesign" >
			...
			<tr style="font-size: 15px;  text-align: right; color:white; border-color: #9b5eff;height:12px;">
				<th style="text-align: center;background-color:#a56eff;border-color: #863cff;width:33.33%;">Year</th>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div class="col-sm-3">
<div class="card" style="border: solid 3px #9b5eff; border-radius: 20px; height:400px; width:475px;">
<div class="card-body" style=" height:400px; width:475px;">
<!-- <h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Departure : Indian/Foreigner Statistics in last 7 days</h1> -->

	<canvas id="canvasWeeklyNationality" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #d9c1fe 100%); border-radius: 20px; height:400px; width:475px;"></canvas>
	</div>
	</div>	
	</div>
	</div>
...
<!--<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Arrival : Gender Based Statistics in last 7 days</h1>-->
		...
		<canvas id="canvasUcf_Ind_Arr" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #faceda 100%);border-radius: 20px; height:400px;width:450px;"></canvas>
	</div>
	</div>	
	</div>
...
<!--<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Arrival : Gender Based Statistics in last 7 days</h1>-->
		...
		<canvas id="canvasUcf_Ind_Dep" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #bae6ff 100%);border-radius: 20px; height:400px;width:450px;"></canvas>
	</div>
	</div>	
	</div>
	</div>
	...
	try {
		...
		while (rsTemp.next()) {
			...
			/*if(rsTemp.getInt("sum_hourly_others_count") == 0)
				...
				weeklyOthersCount_Arrg = rsTemp.getInt("sum_hourly_others_count") + (( weeklyMatchedFgnrArr + weeklyNotMatchedFgnrArr )/100);
				*/
...
<%
	...
	/* othersDatag = strweekNotMatchedFgnrUcf.replaceAll(",0",",");
	if(othersDatag.substring(0,1).equals("0"))
		othersDatag = othersDatag.substring(1,othersDatag.length());
		*/
	//out.println(othersDatag);
...
<!--<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Arrival : Gender Based Statistics in last 7 days</h1>-->
		...
		<canvas id="canvasUcf_Fgnr_Arr" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #faceda 100%);border-radius: 20px; height:400px;width:450px;"></canvas>
	</div>
	</div>	
	</div>
...
<!--<h1 style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
	 background-color: #ffffff">Arrival : Gender Based Statistics in last 7 days</h1>-->
		...
		<canvas id="canvasUcf_Fgnr_Dep" class="chart" style="max-width: 100%;    background: linear-gradient(to bottom, #ffffff 35%, #bae6ff 100%);border-radius: 20px; height:400px;width:450px;"></canvas>
	</div>
	</div>	
	</div>
	</div>
	...
	<table class="tableDesign">
		<!--<caption style="font-size: 22px; color: grey; line-height: 50px; text-align: center; padding-top: 5px;font-weight: bold; font-family: 'Arial', serif;">Arrival Clearance in last 7 hours</caption>-->
				...
				<tr style="font-size: 15px;  text-align: right; color:white; border-color: #028fff;">
					<th style="text-align: center; background-color:#25a5ff;border-color: #028fff;width:12.5%; ">S.No.</th>
					...
					<th style="text-align: center;  background-color:#25a5ff;border-color: #028fff;width:12.5%; text-align: right;">PAX&nbsp;Checked&nbsp;&nbsp;</th>
				</tr>
		<% 
					int counter = 0;
	...
	<table class="tableDesign">
		<!--<caption style="font-size: 22px; color: grey; line-height: 50px; text-align: center; padding-top: 5px;font-weight: bold; font-family: 'Arial', serif;">Arrival Clearance in last 7 hours</caption>-->
				...
				<tr style="font-size: 15px;  text-align: right; color:white; border-color: #007d79;">					
					<th style="text-align: center;  background-color:#0094ab;border-color: #007d79; text-align: center;">S.No.</th>
					...
					<th style="text-align: center;  background-color:#0094ab;border-color: #007d79; text-align: right;">PAX&nbsp;Checked&nbsp;&nbsp;</th>
				</tr>
		<% 
					int counter = 0;
...
<div class="container-fluid">
	...
	<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center;height:20px; hover">
		<td style="background-color:#fc898f;border-color: #da1e28;width:25%; font-weight: bold;text-align: center;"><%=weeklyDaysAgewise[i].replace("-","&#8209;")%></td>
...
<!-- <h1 style="font-size: 20px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif;
 ...
 -->
		<canvas id="canvasWeeklyAgewise2" class="chart" style="max-width: 100%;  background: linear-gradient(to bottom, #ffffff 35%, #f79bbe 100%);border-radius: 20px;height:550px; "></canvas>
	</div>
	</div>	
	</div>
	</div>
