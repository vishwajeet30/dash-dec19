...
function letternumber(e, str)
		...
		function compare_report()
		{
				...
				document.entryfrm.action="test.jsp?&icp="+document.entryfrm.compare_icp.value;
		...
		function compare_hrs()
		{
				...
				document.entryfrm.action="test.jsp?&icp="+document.entryfrm.compare_icp.value+"&default_hrs="+document.entryfrm.default_hrs.value;
				document.entryfrm.submit();
				return true;
